...
fn witherbloom_mossglobe_b154_taps_for_black_or_green_then_sacs_for_three_life() {
    ...
    g.perform_action(GameAction::ActivateAbility {
        card_id: mg, ability_index: 0, target: None, additional_targets: Vec::new(), x_value: None, mode: None,
    ...
    g.perform_action(GameAction::ActivateAbility {
        card_id: mg, ability_index: 1, target: None, additional_targets: Vec::new(), x_value: None, mode: None,
    ...
    let life_before = g.players[0].life;
    g.perform_action(GameAction::ActivateAbility {
        card_id: mg, ability_index: 2, target: None, additional_targets: Vec::new(), x_value: None, mode: None,
