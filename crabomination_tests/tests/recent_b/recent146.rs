...
fn back_for_seconds_bargained_reanimates() {
    ...
    let fodder = g.add_token_to_battlefield(0, &crabomination::game::effects::treasure_token());
    let spell = g.add_card_to_hand(0, catalog::back_for_seconds());
    g.players[0].mana_pool.add(Color::Black, 1);
    g.players[0].mana_pool.add_colorless(2);
    g.decider = Box::new(crabomination::decision::ScriptedDecider::new([
        crabomination::decision::DecisionAnswer::Bool(true), // accept the reanimation
    ]));
