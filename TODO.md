...
2. **Gates at this run's tip (2026-09-25, session `018BnccM` run 5, after Veloci-Ramp-Tor):** suite **22,429 / 0 / 7** (strict answer log); workspace clippy **0**; `--bench` **195,806 / 0 stalls — byte-identical**, `determinism ok`; 4-seat (seed 10480, with `--card-census`: nothing unplayed in seats 152-155) and 6-seat (10481) pods 1,000/1,000 decided; strict debug pods 180/180; cube/sos/sealed 7,500 decided.
