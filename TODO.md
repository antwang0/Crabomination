...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Nature's Vengeance (C18, Gyrus, Waker of Corpses, 18; `011A87o2`, 2026-09-24 14:21 UTC — yielded Death Toll to `01546QdT`, who claimed first).** **Witherbloom Pestilence (SOC, Dina, Essence Brewer, 14; `015cKV6u`, 2026-09-24 run 3).** **Blame Game (MKC, Nelly Borca, Impulsive Accuser, 18; `018BnccM`, 2026-09-24).** **Nature of the Beast (C13, Marath, Will of the Wild, 16; `01P5KQkY`, 2026-09-24 run 2).** **Mind Seize (C13, Jeleva, Nephalia's Scourge, 18; `01546QdT`, 2026-09-24 17:40).** **Draconic Destruction (SCD, Atarka, World Render, 19; `01XnuL2a`, 2026-09-24 run 4).** **Planeswalker Party (CMM, Commodore Guff, 17; `01StaUuo`, 2026-09-24 run 5).** Claim in this line, pushed on its own, before starting a list.
