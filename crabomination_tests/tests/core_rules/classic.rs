...
fn cast_creature(g: &mut GameState, def: crabomination::card::CardDefinition) -> CardId {
    let name = def.name;
...
type BodyCase = (fn() -> crabomination::card::CardDefinition, i32, i32, &'static [Keyword]);
