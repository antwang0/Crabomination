...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Desert Bloom (OTC, Yuma, Proud Protector, 19; `015cKV6u`, 2026-09-25 run 6).** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Arcane Maelstrom (C20, Kalamax, the Stormsire, 18; `01XnuL2a`, 2026-09-25 run 4).** **Enhanced Evolution (C20, Otrimi, the Ever-Playful, 19; `01XnuL2a`, 2026-09-25 run 4).** **Cavalry Charge (MOC, Sidar Jabari of Zhalfir, 19; `016DJoKA`, 2026-09-25 run 1).** **Tricky Terrain (M3C, Omo, Queen of Vesuva, 18; `018BnccM`, 2026-09-25 run 5).** **Timeless Wisdom (C20, Gavi, Nest Warden, 19; `01SSG31v`, 2026-09-25 run 7).** Claim in this line, pushed on its own, before starting a list.
