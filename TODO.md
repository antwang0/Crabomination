...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Hail, Caesar (PIP, Caesar, Legion's Emperor, 33; `018BnccM`, 2026-09-25 run 5).** **The Fantastic Four (MSC, 34; `011z4qQX`, 2026-09-25).** **Forces of the Imperium (40K, Inquisitor Greyfax, 35; `01P5KQkY`, 2026-09-25 run 3).** Claim in this line, pushed on its own, before starting a list.
