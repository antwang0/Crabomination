...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Scions & Spellcraft (FIC, Y'shtola, Night's Blessed, 26; `01P5KQkY`, 2026-09-25 run 3).** **Blight Curse (ECC, Auntie Ool, Cursewretch, 30; `01TfrB1i`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
