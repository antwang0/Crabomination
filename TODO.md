...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Prismari Artistry (SOC, Rootha, Mastering the Moment, 19; `015cKV6u`, 2026-09-24 run 6).** **Coven Counters (MIC, Leinore, Autumn Sovereign, 18; `016DJoKA`, 2026-09-25 run 1).** **Arcane Maelstrom (C20, Kalamax, the Stormsire, 18; `01XnuL2a`, 2026-09-25 run 4).** **Most Wanted (OTC, Olivia, Opulent Outlaw, 18; `018BnccM`, 2026-09-25 run 5).** **Miracle Worker (DSC, Aminatou, Veil Piercer, 16; `01SSG31v`, 2026-09-25 run 7).** Claim in this line, pushed on its own, before starting a list.
