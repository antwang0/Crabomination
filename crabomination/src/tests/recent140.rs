...
fn food_coma_exiles_until_leaves() {
    ...
    let ctx = crate::game::effects::EffectContext::for_ability(coma_id, 0, Some(Target::Permanent(coma_id)));
    g.resolve_effect(&crate::effect::Effect::Destroy { what: crate::effect::Selector::Target(0) }, &ctx)
        .unwrap();
