...
9. ✅ **Checked this run and NOT gaps:** a cube draw at seeds 9922/9923 is `undecided_by draw 1`, a rules outcome; Elemental Expressionist keeps its end-of-turn shape (its leave-exile lasts one turn, `ExileIfLeavesBattlefield` is permanent); surveil isn't recorded as "from the library" by design (every current reader says mill).
