...
2. **Session `01HFhNih` (Necron Dynasties as seat 177):** suite 22,812 / 0 / 7 before the upstream Saga-ratchet fix; workspace clippy 0; `--bench` **200,190 byte-identical** with the unearth fix and the shrink reclass; 4-seat (seed 17701, seats 177/176/175/174, `--card-census`: nothing unplayed) 999/1,000 decided (1 draw), 6-seat (17702, 177-172) 998/1,000 (2 draws); strict debug pods 17703-17706 (4 and 6 seats with 178) all decided. 2. **Gates at this run's tip (2026-09-25, session `018BnccM` run 5, after Doom Prevails as seat 176):** suite **22,755 / 0 / 7** (strict answer log); workspace clippy **0**; `--bench` **200,190 decisions — byte-identical to the invariant**, `determinism ok`; 4-seat (seed 10530, seats 176/175/174/170, `--card-census`: nothing unplayed) and 6-seat (10531, seats 176/175/174/173/172/171) pods 1,000/1,000 decided; cube / sos / sealed 300 games each decided. **Session `011z4qQX` (before seats 176-177 landed):** suite 22,756 / 0 / 7, `--bench` 200,190 byte-identical after the cluttered-board sacrifice gate; census over seats 1-175 (six-seat batches, 300 games, seeds 20001+) decided every game but one board cap, now fixed (decks 73-78, seed 20073 → 300/300).
