//! CR 701.15 — who a creature is goaded by. Three sources: a resolved goad
//! (`goaded_by`, until the goader's next turn), a held goad (`goad_holds`,
//! "as long as", CR 611.2b), and an attached Aura or Equipment that says the
//! creature "is goaded" (`StaticEffect::AttachedIsGoaded`). Every reader of
//! goad asks here so the three can't disagree.
