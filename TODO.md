...
1. **Where it stands:** every row in FEATURE_ROADMAP's **"Commander status"** is ✅, per-opponent targeting included — CR 903 core, the 800-series, the whole variant-mechanic list including Doctor's companion. **Read that table, don't re-audit.** Per-deck completion is DECK_FEATURES' "Commander target decks": **5/5 complete**, the fifth being the Partner seat.
