...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Forces of the Imperium (40K, Inquisitor Greyfax, 35; `01P5KQkY`, 2026-09-25 run 3).** **Doom Prevails (MSC, Doctor Doom, King of Latveria, 38; `018BnccM`, 2026-09-25 run 5).** **Necron Dynasties (40K, Szarekh, the Silent King, 42; `01HFhNih`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
