...
- **LCI cards still ⏳** (need bespoke primitives): Starving Revenant
  ...
  Cave-mana-spent count), Guardian of the Great Door
  (`AdditionalCastCost::TapPermanents`), Bringer of the Last Gift (mass sac +
  mass reanimate), Song of Stupefaction (graveyard-count EquipScale), Intrepid
  ...
  `Effect::AddCountersForPowerOverBase` (Sovereign Okinec Ahau), Nicanzil, Sage
  of Days, Deepfathom Echo. Easy LCI commons sit in `sets::lci` with tests in
  `tests::lci`.
