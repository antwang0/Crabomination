...
2. **Gates at this run's tip (2026-09-25, session `018BnccM` run 5):** suite **21,707 / 0 / 7** (strict answer log); workspace clippy **0**; `--bench` **195,806 / 0 stalls — byte-identical**, `determinism ok`; 4-seat pods 1,000/1,000 decided per new seat; strict debug pods 240/240 (4 and 6 seats); cube/sos/sealed 7,500 decided; every card of every seated list played in the census.
