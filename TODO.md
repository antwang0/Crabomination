...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Counter Blitz (FIC, Tidus, Yuna's Guardian, 28; `011z4qQX`, 2026-09-25).** **From Cute to Brute (SLD, Esika, God of the Tree, 28; `01P5KQkY`, 2026-09-25 run 3).** **Mutant Menace (PIP, The Wise Mothman, 34; `01TfrB1i`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
