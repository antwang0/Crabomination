...
use crate::catalog;
use crate::effect::{Effect, EventKind, Selector};
...
fn bloodhall_ooze_has_two_color_gated_upkeep_growers() {
    use crate::card::{Predicate, SelectionRequirement as R};
...
fn colossodon_yearling_is_a_beast() {
    ...
    assert!(c.subtypes.creature_types.contains(&crate::card::CreatureType::Beast));
}
