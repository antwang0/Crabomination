        ...
        triggered_abilities: vec![on_cast(Effect::GainLife {
            ...
            amount: Value::CountMatching {
                sel: Box::new(Selector::EachPermanent(
                    R::ControlledByYou.and(R::Colorless),
                )),
...
pub fn drownyard_lurker() -> CardDefinition {
    let make_spawn = || Effect::CreateToken {
        who: PlayerRef::You,
        count: Value::ONE,
        definition: std::sync::Arc::new(crate::game::effects::eldrazi_spawn_token()),
    };
    CardDefinition {
        ...
        keywords: vec![
            Keyword::Vigilance,
            Keyword::Cycling(cost(&[generic(2), u()])),
        ],
...
pub fn voidpouncer() -> CardDefinition {
    ...
    CardDefinition {
        ...
        keywords: vec![
            Keyword::Devoid,
            Keyword::Kicker(cost(&[generic(2), colorless(1)])),
        ],
        triggered_abilities: vec![TriggeredAbility {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::Seq(vec![
            Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(2),
                definition: std::sync::Arc::new(gremlin),
            },
        ...
        effect: Effect::Seq(vec![
            ...
            Effect::CounterSpell {
                what: target_filtered(
                    R::IsSpellOnStack.and(R::Artifact.or(R::Creature).or(R::Planeswalker)),
                ),
            },
        ]),
        ..Default::default()
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![
            etb(Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::ONE,
                definition: std::sync::Arc::new(spirit_flyer()),
            }),
            TriggeredAbility {
