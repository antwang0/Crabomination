...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Desert Bloom (OTC, Yuma, Proud Protector, 19; `015cKV6u`, 2026-09-25 run 6).** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Cavalry Charge (MOC, Sidar Jabari of Zhalfir, 19; `016DJoKA`, 2026-09-25 run 1).** **Timeless Wisdom (C20, Gavi, Nest Warden, 19; `01SSG31v`, 2026-09-25 run 7).** **Riveteers Rampage (NCC, Henzie "Toolbox" Torre, 19; `01XnuL2a`, 2026-09-25 run 4).** **Eternal Bargain (C13, Oloro, Ageless Ascetic, 20; `016DJoKA`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
