...
fn magecraft_life_effects_after_bolt_table() {
    ...
    for (def, ping, gain, kw) in [
        ...
        (catalog::witherbloom_ravager_b158(), 1, 0, None),
        (catalog::pest_marauder_b160(), 1, 0, Some(Keyword::Menace)),
        (catalog::witherbloom_drainspore_b160(), 1, 0, None),
        (catalog::pest_vinetiller_b160(), 0, 0, None),
        (catalog::lorehold_sparkpriest_b160(), 1, 0, None),
        (catalog::lorehold_pyrescholar_b161(), 1, 0, None),
        (catalog::prismari_voidshaper_b161(), 1, 0, None),
        (catalog::witherbloom_sapseer_b162(), 0, 0, None),
        (catalog::silverquill_apprentice_ii_b162(), 1, 0, None),
