...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Cavalry Charge (MOC, Sidar Jabari of Zhalfir, 19; `016DJoKA`, 2026-09-25 run 1).** **Timeless Wisdom (C20, Gavi, Nest Warden, 19; `01SSG31v`, 2026-09-25 run 7).** **Riveteers Rampage (NCC, Henzie "Toolbox" Torre, 19; `01XnuL2a`, 2026-09-25 run 4).** **Eternal Bargain (C13, Oloro, Ageless Ascetic, 20; `016DJoKA`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
