...
pub fn pillar_of_light() -> CardDefinition {
    spell(
        ...
        CardType::Instant,
        Effect::Exile {
            what: target_filtered(R::Creature.and(R::ToughnessAtLeast(4))),
        },
    )
}
...
pub fn chief_engineer() -> CardDefinition {
    CardDefinition {
        static_abilities: vec![StaticAbility {
            ...
            effect: StaticEffect::GrantConvokeToSpells {
                filter: R::Artifact,
            },
        }],
        ..creature(
...
pub fn might_makes_right() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            .with_filter(Predicate::ControlsEachGreatestPowerCreature {
                who: PlayerRef::You,
            }),
            effect: Effect::Seq(vec![
                Effect::GainControl {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            .with_filter(Predicate::Not(Box::new(
                Predicate::ActivatedLoyaltyThisTurn {
                    who: PlayerRef::You,
                },
            ))),
            effect: Effect::LoseLife {
