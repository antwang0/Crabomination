...
7. **Leads:** Y'shtola (163) won 56 % of six-seat pods (seed 17302) — what her drain does that the attack decks don't; constant shrinks (Disfigure) are still combat tricks (moves 2-player traces); INCOMPLETE_CARDS' Commander rows are mostly "the engine picks" choices.
