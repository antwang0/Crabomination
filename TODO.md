...
2. **Gates at this run's tip (2026-09-25, session `01XnuL2a` run 4):** suite **21,644 / 0 / 7**; release-fast check green; workspace clippy **0**; `--bench` **195,806 / 27.49 / 611.9 / 0 stalls — byte-identical** after every change; 4-seat pods 1,000/1,000 decided per new seat with every card of the four lists played; strict debug pods 120/120 per seat; a broad 1,800-game smoke over seats 81-110 decided 1,799 (one CR 104.4a draw), zero panics.
...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Prismari Artistry (SOC, Rootha, Mastering the Moment, 19; `015cKV6u`, 2026-09-24 run 6).** **Subjective Reality (C18, Aminatou, the Fateshifter, 19; `01StaUuo`, 2026-09-24 run 6).** **Mardu Surge (TDC, Zurgo Stormrender, 19; `01SSG31v`, 2026-09-24 run 7).** **Coven Counters (MIC, Leinore, Autumn Sovereign, 18; `016DJoKA`, 2026-09-25 run 1).** **Arcane Maelstrom (C20, Kalamax, the Stormsire, 18; `01XnuL2a`, 2026-09-25 run 4).** Claim in this line, pushed on its own, before starting a list.
