...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Ahoy Mateys (LCC, Admiral Brass, Unsinkable, 25; `01P5KQkY`, 2026-09-25 run 3).** **Revenant Recon (MKC, Mirko, Obsessive Theorist, 25; `01TfrB1i`, 2026-09-25 run 1).** **Limit Break (FIC, Cloud, 22; `016DJoKA`, 2026-09-25 run 1).** **Food and Fellowship (LTC, Frodo + Sam, 27; `01RyGJHK`, 2026-09-25 run 1).** **Multiverse Reforged (FRC, Jace, Multiverse Architect, 20; `018BnccM`, 2026-09-25 run 5).** Claim in this line, pushed on its own, before starting a list.
