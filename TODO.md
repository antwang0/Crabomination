...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Enduring Enchantments (CMM, Anikthea, Hand of Erebos, 17; `01546QdT`, 2026-09-24 12:05).** **Growing Threat (MOC, Brimaz, Blight of Oreskos, 17; `01P5KQkY`, 2026-09-24 run 2).** **Phantom Premonition (KHC, Ranar the Ever-Watchful, 18; `01XnuL2a`, 2026-09-24 run 4).** **Undead Unleashed (MIC, Wilhelt, the Rotcleaver, 18; `011A87o2`, 2026-09-24 13:00).** **Urza's Iron Alliance (BRC, Urza, Chief Artificer, 16; `01StaUuo`, 2026-09-24 run 5).** Claim in this line, pushed on its own, before starting a list.
