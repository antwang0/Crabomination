...
fn blue_pool(pair: [Color; 2]) -> Vec<CardFactory> {
    let mut v: Vec<CardFactory> = vec![
        ...
        nessian_demolok,
        thunder_brute,
        snake_of_the_golden_grove,
        lash_out,
        tempt_with_glory,
        tempt_with_vengeance,
        tempt_with_reflections,
        vexing_shusher,
        crypt_sliver,
        hibernation_sliver,
        necrotic_sliver,
...
fn black_pool(pair: [Color; 2]) -> Vec<CardFactory> {
    let mut v: Vec<CardFactory> = vec![
        ...
        silversmote_ghoul,
        bitterbloom_bearer,
        // flashback "sacrifice three creatures" wired via flashback_additional_cost
        dread_return,
        tidehollow_sculler,
        phyrexian_arena,
        bloodchiefs_thirst,
