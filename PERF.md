...
| | **cumulative this run** | **7,994,965,799 Ir** | **7,035,606,377 Ir (-12.00 %)** | five alternated `profiling-fast --no-default-features` callgrind A/Bs on the one fixed six-game workload, so the five rows subtract honestly |
