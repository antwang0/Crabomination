...
5. **⚠ OPEN CLAIMS — don't duplicate:** **20 Ways to Win (SLD, 16; `01StaUuo`, 2026-09-24 run 6) — ⚠ ALREADY LANDED as seat 92 by `01546QdT` (claimed 19:30, landed before this claim); drop it.** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Prismari Artistry (SOC, Rootha, Mastering the Moment, 19; `015cKV6u`, 2026-09-24 run 6).** **Painbow (DMC, Jared Carthalion, 18; `01XnuL2a`, 2026-09-24 run 4).** **Ruthless Regiment (C20, Jirina Kudro, 19; `018BnccM`, 2026-09-24 run 5).** **Prismari Performance (C21, Zaffai, Thunder Conductor, 18; `01546QdT`, 2026-09-24 23:20).** Claim in this line, pushed on its own, before starting a list.
