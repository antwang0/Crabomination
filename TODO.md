...
2. **Gates at this run's tip (2026-09-25, session `01RyGJHK`, after the Altisaur fix):** suite **22,573 / 0 / 7** (strict answer log); workspace clippy **0**; `release-fast` typecheck clean; `--bench` **195,806 / 27.49 / 0 stalls — byte-identical** after every change; pods at seed 9401, 2..8 seats × 2,000 = **14,000 decided, 0 panics** (turns/game 19.68 / 33.05 / 46.12 / 57.72 / 66.24 / 78.36 / 94.38); 8-seat pods over seats 123-162 (seeds 9402-9404) 8,000 / 8,000 after the three fixes they found; strict debug pods 6 × 30 over seats 139-162 all decided; cube / sos / sealed 7,500 decided.
