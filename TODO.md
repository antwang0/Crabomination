...
5. **⚠ OPEN CLAIMS — don't duplicate:** Open Hostility (C16, Saskia, 16; `01XnuL2a`). **First Flight (SCD, Isperia, Supreme Judge, 18; `011A87o2`, 2026-09-24 11:20).** **Arcane Wizardry (C17, Inalla, Archmage Ritualist, 16; `01StaUuo`, 2026-09-24 run 5).** **Enduring Enchantments (CMM, Anikthea, Hand of Erebos, 17; `01546QdT`, 2026-09-24 12:05).** Claim in this line, pushed on its own, before starting a list.
