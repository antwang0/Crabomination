...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Prismari Artistry (SOC, Rootha, Mastering the Moment, 19; `015cKV6u`, 2026-09-24 run 6).** **Painbow (DMC, Jared Carthalion, 18; `01XnuL2a`, 2026-09-24 run 4).** **Prismari Performance (C21, Zaffai, Thunder Conductor, 18; `01546QdT`, 2026-09-24 23:20).** **Subjective Reality (C18, Aminatou, the Fateshifter, 19; `01StaUuo`, 2026-09-24 run 6).** **Mardu Surge (TDC, Zurgo Stormrender, 19; `01SSG31v`, 2026-09-24 run 7).** Claim in this line, pushed on its own, before starting a list.
