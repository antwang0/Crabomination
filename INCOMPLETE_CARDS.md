...
| 🟡 Dawn Charm | Arm for Battle (CMR) | the counter mode also takes a spell that targets a permanent you control (Hindering Light's filter). |
| 🟡 Timely Ward | Arm for Battle (CMR) | flash is offered while any commander is on the battlefield, not only when it targets one. |
