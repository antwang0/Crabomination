...
2. **Gates at this run's tip (2026-09-25, session `01TfrB1i` run 1, after Scrappy Survivors as seat 173):** suite **22,714 / 0 / 7** (strict answer log, before the Avengers rebase); workspace clippy **0** (after the rebase); `--bench` **195,806 decisions / 27.49 turns — byte-identical**; `release-fast` check green at the pushed tip; 4-seat (seed 17301, seats 173/169/170/166, `--card-census`: nothing unplayed) and 6-seat (17302, seats 173/172/171/165/164/163) pods 1,000/1,000 decided (the 6-seat one after the optional-token fix).
