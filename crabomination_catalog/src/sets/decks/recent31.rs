    ...
    CardDefinition {
        ...
        effect: Effect::ChooseN {
            ...
            modes: vec![
                ...
                Effect::PutFromHandOrGraveyardOntoBattlefield {
...
pub fn lhurgoyf() -> CardDefinition {
    goyf_body(
        "Lhurgoyf",
        cost(&[generic(2), g(), g()]),
        vec![CreatureType::Lhurgoyf],
        DynamicPt::CreatureCardsInAllGraveyards {
            base_p: 0,
            base_t: 1,
        },
    )
