...
2. **Gates at this run's tip (2026-09-25, session `018BnccM` run 5):** suite **21,808 / 0 / 7** (strict answer log); workspace clippy **0**; `--bench` **195,806 / 0 stalls — byte-identical**, `determinism ok`; 4-seat pods 1,000/1,000 decided per new seat (one unrelated Chishiro/Nelly no-progress draw, open queue); strict debug pods 420/420 (4 and 6 seats); cube/sos/sealed 7,500 decided; every card of every seated list played in the census.
...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Cavalry Charge (MOC, Sidar Jabari of Zhalfir, 19; `016DJoKA`, 2026-09-25 run 1).** **Timeless Wisdom (C20, Gavi, Nest Warden, 19; `01SSG31v`, 2026-09-25 run 7).** **Riveteers Rampage (NCC, Henzie "Toolbox" Torre, 19; `01XnuL2a`, 2026-09-25 run 4).** **Eternal Bargain (C13, Oloro, Ageless Ascetic, 20; `016DJoKA`, 2026-09-25 run 1).** **Grand Larceny (OTC, Gonti, Canny Acquisitor, 19; `01XnuL2a`, 2026-09-25 run 4).** Claim in this line, pushed on its own, before starting a list.
