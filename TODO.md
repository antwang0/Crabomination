...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Forces of the Imperium (40K, Inquisitor Greyfax, 35; `01P5KQkY`, 2026-09-25 run 3).** **The Ruinous Powers (40K, Abaddon the Despoiler, 41; `018BnccM`, 2026-09-25 run 5).** **Turtle Power! (TMC, 48; `011z4qQX`, 2026-09-25).** Claim in this line, pushed on its own, before starting a list.
