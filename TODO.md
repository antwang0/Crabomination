...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Forces of the Imperium (40K, Inquisitor Greyfax, 35; `01P5KQkY`, 2026-09-25 run 3).** **Doom Prevails (MSC, Doctor Doom, King of Latveria, 38; `018BnccM`, 2026-09-25 run 5).** **Tyranid Swarm (40K, The Swarmlord, 40; `01TfrB1i`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
