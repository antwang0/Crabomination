...
5. **⚠ OPEN CLAIMS — don't duplicate:** **20 Ways to Win (SLD, 16; `01StaUuo`, 2026-09-24 run 6) — ⚠ ALREADY LANDED as seat 92 by `01546QdT` (claimed 19:30, landed before this claim); drop it.** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Symbiotic Swarm (C20, Kathril, Aspect Warper, 19; `01XnuL2a`, 2026-09-24 run 4).** **Adaptive Enchantment (C18, Estrid, the Masked, 18; `018BnccM`, 2026-09-24 run 3).** **Upgrades Unleashed (NEC, Chishiro, the Shattered Blade, 18; `01SSG31v`, 2026-09-24 run 7).** **Draconic Rage (AFC, Vrondiss, Rage of Ancients, 18; `01546QdT`, 2026-09-24 23:05).** **Eldrazi Unbound (CMM, Zhulodok, Void Gorger, 18; `01StaUuo`, 2026-09-24 run 6).** **Silverquill Influence (SOC, Killian, Decisive Mentor, 17; `015cKV6u`, 2026-09-24 run 6).** Claim in this line, pushed on its own, before starting a list.
