...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Creative Energy (M3C, Satya, Aetherflux Genius, 18; `015cKV6u`, 2026-09-25 run 7).** **Obscura Operation (NCC, Kamiz, Obscura Oculus, 20; `01P5KQkY`, 2026-09-25 run 3).** **Bedecked Brokers (NCC, Perrie, the Pulverizer, 21; `016DJoKA`, 2026-09-25 run 1).** Claim in this line, pushed on its own, before starting a list.
