    ...
    CardDefinition {
        ...
        effect: Effect::CounterSpell {
            what: target_filtered(
                SelectionRequirement::IsSpellOnStack.and(SelectionRequirement::ManaValueAtLeast(4)),
            ),
        },
        ..Default::default()
    }
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::Move {
                what: Selector::TargetFiltered {
                    slot: 0,
                    filter: SelectionRequirement::Creature.and(SelectionRequirement::InGraveyard),
                },
...
/// battlefield tapped (no timing rider is printed; it shipped sorcery-speed until 2026-09-07); if it
/// would then leave the battlefield it's exiled instead. (The Domain cost
    ...
    CardDefinition {
        ...
        activated_abilities: vec![ActivatedAbility {
            ...
            effect: Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: std::sync::Arc::new(samurai),
            },
            ..Default::default()
        }],
        ..Default::default()
