...
0. **Next set to close.** Odyssey is open (`set_gaps.py ody` 274 → 94,
   `sets::ody::gaps`–`gaps6`); keep the wave pattern going, then Torment and
...
- **Odyssey (ODY) opened** — 180 cards (`sets::ody::gaps`–`gaps6`, tests in
