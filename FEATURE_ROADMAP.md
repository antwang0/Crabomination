...
| Most-built commanders and top-1000 staples in the catalog | 🟡 *2026-09-26* | `decks::cmdr_legends` (Aragorn, Zur, Flubs, Galadriel, Arcades, Tiamat, Sauron, Morcant, Jodah, Thranduil, Queza, Child of Alara, Liesa, Urtet, Isshin, Tergrid, Najeela) and `decks::cmdr_top1000` (Xorn, Peregrin Took, Flowering of the White Tree, Lotho, Borne Upon a Wind, Imp's Mischief, Boromir, Jaheira, Torment of Hailfire, High Tide, Beseech the Mirror, Ojer Taq). COMMANDER_BACKLOG.md is stale (generated 2026-09-20) — re-run `scripts/commander_backlog.py`; Excalibur added (a filtered-only equip cost now works, CR 702.6a); Archway of Innovation rides the new `Effect::NextSpellGainsImproviseThisTurn` — the §2 top-1000 list is now fully in the catalog. Rounded-off parts in INCOMPLETE_CARDS' session `015BCEt5` table |
