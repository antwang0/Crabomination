...
fn guard_change_hangs_monster_role() {
    ...
    assert!(b.keywords.contains(&crate::card::Keyword::Trample), "Role grants trample");
}
...
fn hare_raising_scales_with_board() {
    ...
    assert!(c.keywords.contains(&crate::card::Keyword::Vigilance), "gains vigilance");
}
...
fn free_the_fae_mills_and_takes() {
    ...
    g.decider = Box::new(crate::decision::ScriptedDecider::new([
        crate::decision::DecisionAnswer::Cards(vec![bolt]),
    ]));
