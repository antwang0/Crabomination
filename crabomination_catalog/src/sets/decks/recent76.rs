...
use crate::mana::{Color, ManaCost, b, cost, g, generic, r, w};
...
pub fn ironclaw_orcs() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Orc],
            ..Default::default()
        },
        power: 2,
        toughness: 2,
...
pub fn cockatrice() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Cockatrice],
            ..Default::default()
        },
        power: 2,
        toughness: 4,
...
pub fn skeletal_snake() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Snake, CreatureType::Skeleton],
            ..Default::default()
        },
        power: 2,
        toughness: 1,
...
pub fn davenant_archer() -> CardDefinition {
    CardDefinition {
        ...
        activated_abilities: vec![ActivatedAbility {
            ...
            effect: deal(
                1,
                target_filtered(R::Creature.and(R::IsAttacking.or(R::IsBlocking))),
            ),
            ..Default::default()
        }],
        ..Default::default()
