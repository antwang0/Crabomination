...
/// Witherbloom Sap-Caller (b146) — {1}{B}{G} 2/3 Human Warlock.
/// Magecraft drain 1. 3-mana Witherbloom Apprentice's slightly bigger
/// cousin (one extra toughness).
pub fn witherbloom_sap_caller_b146() -> CardDefinition {
    use crate::effect::shortcut::magecraft_drain;
    CardDefinition {
...
/// Pest Wraith (b146) — {2}{B} 2/2 Pest Spirit. Dies → each opp loses 2
/// life. Aristocrat-style death-drain — see Inkling Wraith for the
/// Inkling mirror.
pub fn pest_wraith_b146() -> CardDefinition {
...
/// Witherbloom Toxicologist (b146) — {1}{G} 1/3 Human Druid.
/// ETB Mill 2. Cheap self-mill body that feeds Witherbloom recursion.
pub fn witherbloom_toxicologist_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Reapcaster (b146) — {2}{B}{G} 3/3 Pest Warlock.
/// Magecraft +1/+1 counter on this creature + drain 1. Scaling
/// magecraft drain — see Silverquill Devout for the +1/+1-only flavor.
pub fn witherbloom_reapcaster_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Spore-Cleric (b146) — {1}{B} 1/2 Pest Cleric. ETB mints
/// one Pest token. 2-mana double-body — feeds Witherbloom Apprentice's
/// magecraft drain via the Pest's own death-life trigger.
pub fn witherbloom_spore_cleric_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapveiler (b146) — {2}{G} 3/3 Pest Druid Deathtouch.
/// 3-mana big-toughness deathtouch body — race-stalling defender that
/// trades up.
pub fn witherbloom_sapveiler_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Withergrove (b146) — {3}{B}{G} Sorcery. Seq(Drain 3 +
/// CreateToken(1 Pest)). 5-mana drain-and-body finisher.
pub fn witherbloom_withergrove_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pest-Herder (b146) — {2}{B}{G} 2/4 Human Druid.
/// Static "Other Pest creatures you control get +1/+1." Pest-tribal
/// anthem at 4 mana.
pub fn witherbloom_pest_herder_b146() -> CardDefinition {
    use crate::card::StaticAbility;
    use crate::effect::StaticEffect;
    CardDefinition {
...
/// Witherbloom Festerstalk (b146) — {B}{G} Instant. PumpPT(-3/-3 EOT)
/// on target creature. 2-mana removal-for-3-toughness.
pub fn witherbloom_festerstalk_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Lifeglyph (b146) — {1}{G} Sorcery. GainLife 5. Cheap
/// 2-mana heal — bigger than Silverquill Heartmender's 4-life rider
/// but loses the white flexibility.
pub fn witherbloom_lifeglyph_b146() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Roothunter (b148) — {1}{G} 2/2 Elf Druid Reach.
/// 2-mana ground+air defender. Common ramp shell anchor.
pub fn witherbloom_roothunter_b148() -> CardDefinition {
    CardDefinition {
...
/// Pest Caretaker (b148) — {1}{B}{G} 2/3 Human Druid. ETB mints 2 Pest
/// tokens. 3-mana go-wide Pest engine.
pub fn pest_caretaker_b148() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Hexstrike (b148) — {2}{B} Sorcery. Drain 3. 3-mana drain.
pub fn witherbloom_hexstrike_b148() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Reedwarden (b148) — {B}{G} 2/2 Pest Druid. Static
/// "Other Pest creatures you control get +0/+1." Defensive Pest
/// anthem.
pub fn witherbloom_reedwarden_b148() -> CardDefinition {
    use crate::card::StaticAbility;
    use crate::effect::StaticEffect;
    CardDefinition {
...
/// Witherbloom Pestreaver (b148) — {3}{B}{G} 4/3 Pest Warlock.
/// ETB drain 2 + magecraft drain 1. 5-mana double-drain finisher.
pub fn witherbloom_pestreaver_b148() -> CardDefinition {
    use crate::effect::shortcut::{etb_drain, magecraft_drain};
    CardDefinition {
...
/// Witherbloom Vinepriest (b150) — {3}{B}{G} 3/4 Pest Druid. ETB drain 2.
/// Mid-curve value drain body.
pub fn witherbloom_vinepriest_b150() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestcaller (b150) — {2}{B}{G} 2/2 Human Warlock. ETB mint
/// 2 Pest tokens — Pest-tribal engine card.
pub fn witherbloom_pestcaller_b150() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinedragon (b150) — {3}{B}{G} 4/3 Pest Dragon Flying.
/// Big rare evasive Pest finisher with Lifelink.
pub fn witherbloom_vinedragon_b150() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Rotsage (b150) — {1}{B}{G} 2/3 Pest Warlock.
/// Magecraft drain 1.
pub fn witherbloom_rotsage_b150() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Lifeleech (b150) — {1}{B} Sorcery. Target creature gets
/// -3/-3 EOT, you gain 3 life. Edict-light + lifegain rider.
pub fn witherbloom_lifeleech_b150() -> CardDefinition {
...
/// Witherbloom Spawnbed (b150) — {2}{G} 1/4 Plant defender. Magecraft
/// mint a Pest token.
pub fn witherbloom_spawnbed_b150() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Hatchling (b150) — {B}{G} 1/1 Pest Insect. Persist.
/// 2-mana persistent Pest body.
pub fn witherbloom_hatchling_b150() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Carrion-Eater (b151) — {3}{B} 3/3 Pest Insect.
/// Deathtouch. Aggressive midrange Pest body.
pub fn witherbloom_carrion_eater_b151() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Apothecary (b151) — {2}{B} 2/3 Pest Druid. ETB drain 1.
/// Compact 3-mana defensive drain body.
pub fn witherbloom_apothecary_b151() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinedweller (b151) — {G} 1/2 Pest Spider. Reach.
/// 1-mana evasion-blocker.
pub fn witherbloom_vinedweller_b151() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mire (b151) — {2}{B}{G} Sorcery. Drain 3 + you draw 1.
/// 4-mana drain + cantrip.
pub fn witherbloom_mire_b151() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestmaster (b151) — {1}{B}{G} 2/2 Human Warlock.
/// Magecraft +1/+1 counter on each Pest you control. Pest-tribal engine.
pub fn witherbloom_pestmaster_b151() -> CardDefinition {
    use crate::card::SelectionRequirement;
    CardDefinition {
...
/// Witherbloom Vorpalfang (b152) — {2}{B}{G} 3/3 Pest Warlock.
/// Lifelink + Deathtouch. Dual-keyword midrange Pest finisher.
pub fn witherbloom_vorpalfang_b152() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Cauldronthief (b152) — {2}{B} 2/2 Pest Druid. ETB drain 1
/// + mint a Pest.
pub fn witherbloom_cauldronthief_b152() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mortislide (b152) — {3}{B} Sorcery. Destroy target creature.
/// You gain 2 life if it had a +1/+1 counter on it.
/// (The conditional rider is collapsed — always gains 2 life.)
pub fn witherbloom_mortislide_b152() -> CardDefinition {
    use crate::card::SelectionRequirement;
    CardDefinition {
...
/// Witherbloom Pest Brood (b152) — {3}{B}{G} 1/1 Pest. ETB mints 3
/// additional Pest tokens (4 bodies total including self).
pub fn witherbloom_pest_brood_b152() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Cauldronkeeper (b152) — {1}{B}{G} 2/3 Pest Druid.
/// On-attack drain 1.
pub fn witherbloom_cauldronkeeper_b152() -> CardDefinition {
    CardDefinition {
...
// ── batch 155 — Witherbloom ────────────────────────────────────────────────

/// Witherbloom Bonebinder (b155) — {1}{B} 2/2 Human Warlock. Magecraft
/// drain 1.
pub fn witherbloom_bonebinder_b155() -> CardDefinition {
    CardDefinition {
...
/// Pest Hivescholar (b155) — {2}{G} 2/3 Human Druid. Magecraft mints
/// a Pest token via `magecraft_mint_pest`.
pub fn pest_hivescholar_b155() -> CardDefinition {
    use crate::effect::shortcut::magecraft_mint_pest;
    CardDefinition {
...
/// Witherbloom Cultivator (b155) — {2}{B}{G} 3/3 Human Druid.
/// ETB Seq(GainLife 2 + Surveil 1). Defensive value body.
pub fn witherbloom_cultivator_b155() -> CardDefinition {
    CardDefinition {
...
/// Pest Wrangler (b155) — {1}{B}{G} 2/2 Human Druid. ETB mints 1 Pest
/// token. Pest tribal enabler.
pub fn pest_wrangler_b155() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapling (b155) — {G} 0/2 Plant. {1}{B}{G}: +1/+1
/// counter on self. Persistent green/black grower.
pub fn witherbloom_sapling_b155() -> CardDefinition {
    use crate::card::CounterType;
    CardDefinition {
...
/// Witherbloom Inkblossom (b155) — {B}{G} Instant. Each opp loses 2
/// life and you gain 2 life — vanilla Drain 2.
pub fn witherbloom_inkblossom_b155() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinetalker (b155) — {3}{G} 3/4 Elf Druid Reach.
/// Defensive value body for Witherbloom's grindy game plan.
pub fn witherbloom_vinetalker_b155() -> CardDefinition {
    CardDefinition {
...
/// Pest Conjuror (b155) — {2}{B}{G} 2/3 Human Warlock. ETB mints 2
/// Pest tokens. Token engine for Witherbloom aristocrats.
pub fn pest_conjuror_b155() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Tutor (b155) — {2}{B}{G} Sorcery. Search your library
/// for a creature card, put it into your hand, then shuffle. Costs 2 life.
pub fn witherbloom_tutor_b155() -> CardDefinition {
    CardDefinition {
...
/// Pest Acolyte II (b157) — {B} 1/1 Human Warlock. Magecraft GainLife 1.
/// (Distinct from `pest_acolyte_b155` — same template, different batch.)
pub fn pest_acolyte_ii_b157() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinepoet (b155) — {3}{B}{G} 4/4 Elf Druid Trample.
/// Magecraft AddCounter(+1/+1, self) — grow-on-cast top end.
pub fn witherbloom_vinepoet_b155() -> CardDefinition {
    use crate::effect::shortcut::magecraft_add_counter_self;
    CardDefinition {
...
/// Pest Ringleader (b155) — {3}{B}{G} 3/3 Human Warlock. Static:
/// Other Pest creatures you control get +1/+1. Tribal anthem.
pub fn pest_ringleader_b155() -> CardDefinition {
    use crate::card::StaticAbility;
    CardDefinition {
...
// ── Batch 158 (modern_decks) — Witherbloom cards ───────────────────────────

/// Witherbloom Sapling (b158) — {1}{G} 1/3 Plant Druid Reach.
/// Anti-flier defender body for the Witherbloom Pest shell.
pub fn witherbloom_sapling_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Decantor (b158) — {2}{B} 2/3 Plant Vampire.
/// Magecraft drain 1. Mid-range magecraft drain body.
pub fn witherbloom_decantor_b158() -> CardDefinition {
    CardDefinition {
...
/// Pest Cultivator II (b158) — {B}{G} 1/1 Pest Druid.
/// ETB mint a Pest token. 2-mana double-Pest body.
pub fn pest_cultivator_ii_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainfeeder (b158) — {2}{B}{G} 3/3 Plant Beast.
/// ETB Drain 2 (each opp loses 2, you gain 2). 4-mana race-breaker.
pub fn witherbloom_drainfeeder_b158() -> CardDefinition {
    CardDefinition {
...
/// Pest Engorger II (b158) — {1}{B}{G} 1/1 Pest Beast.
/// Magecraft +1/+1 counter on self. Magecraft-grower at the Pest slot.
pub fn pest_engorger_ii_b158() -> CardDefinition {
    use crate::effect::shortcut::magecraft_add_counter_self;
    CardDefinition {
...
/// Witherbloom Sapdrinker II (b158) — {2}{B}{G} 3/3 Plant Vampire Lifelink.
/// 4-mana lifelink body.
pub fn witherbloom_sapdrinker_ii_b158() -> CardDefinition {
    CardDefinition {
...
/// Pest Wretch (b158) — {B} 1/1 Pest. Magecraft self-pump +1/+0 EOT.
/// Cheapest Pest magecraft trigger.
pub fn pest_wretch_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinepoet II (b158) — {1}{B}{G} 2/3 Plant Druid.
/// Magecraft gain 1 life — Honor Troll lifegain enabler.
pub fn witherbloom_vinepoet_ii_b158() -> CardDefinition {
    CardDefinition {
...
/// Pest Swarmrider (b158) — {3}{B}{G} 3/3 Pest Warrior.
/// ETB mint 2 Pest tokens. 5-mana go-wide finisher.
pub fn pest_swarmrider_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Faminescion (b158) — {2}{B}{G} Sorcery.
/// Drain 3 + Mill 2 (each opp). 4-mana drain + gy-fill.
pub fn witherbloom_faminescion_b158() -> CardDefinition {
    CardDefinition {
...
/// Pest Crawler (b158) — {B}{G} 2/2 Pest Insect Deathtouch.
/// Vanilla deathtouch trade body.
pub fn pest_crawler_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Toxinspear (b158) — {B} Instant. Target creature gets
/// -2/-1 EOT. Cheap soft-removal.
pub fn witherbloom_toxinspear_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Reanimate (b158) — {2}{B}{G} Sorcery.
/// Return target creature card from your graveyard to the battlefield.
pub fn witherbloom_reanimate_b158() -> CardDefinition {
    CardDefinition {
...
/// Pest Bloomer (b158) — {2}{G} 2/2 Plant Druid.
/// ETB mints 1 Pest.
pub fn pest_bloomer_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Coursebinder (b158) — {3}{B}{G} 4/4 Plant Beast Trample.
/// 5-mana big trampler.
pub fn witherbloom_coursebinder_b158() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Ravager (b158) — {2}{B} 2/2 Plant Warlock Deathtouch.
/// Magecraft drain 1.
pub fn witherbloom_ravager_b158() -> CardDefinition {
    CardDefinition {
...
// ── Batch 159 (modern_decks) — More Witherbloom cards ──────────────────────

/// Witherbloom Stinger (b159) — {1}{B} 1/2 Plant Insect Deathtouch.
/// Cheap 2-mana deathtouch trade body.
pub fn witherbloom_stinger_b159() -> CardDefinition {
    CardDefinition {
...
/// Pest Sapling (b159) — {1}{G} 1/3 Pest Plant Reach.
/// 2-mana anti-flier Pest.
pub fn pest_sapling_b159() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Bonebinder (b159) — {2}{B}{G} 2/2 Plant Warlock.
/// ETB Drain 1 + Pest token. 4-mana double payoff.
pub fn witherbloom_bonebinder_b159() -> CardDefinition {
    CardDefinition {
...
/// Pest Sapfeeder (b159) — {2}{G} 2/3 Pest Beast.
/// Magecraft gain 1 life.
pub fn pest_sapfeeder_b159() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Necrotomb (b159) — {1}{B}{G} Sorcery.
/// Each opp mills 3.
pub fn witherbloom_necrotomb_b159() -> CardDefinition {
    CardDefinition {
...
// ── Batch 160 (modern_decks) — Witherbloom additions ───────────────────────

/// Witherbloom Bramblegrowth (b160) — {2}{G} 2/4 Plant Druid Reach.
/// ETB mints a 1/1 B/G Pest token.
pub fn witherbloom_bramblegrowth_b160() -> CardDefinition {
    CardDefinition {
...
/// Pest Marauder (b160) — {2}{B} 3/2 Pest Warrior Menace.
/// Magecraft each opp loses 1 life.
pub fn pest_marauder_b160() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Wreathweaver (b160) — {2}{B}{G} 3/3 Plant Druid Trample.
/// Magecraft self +1/+1 EOT.
pub fn witherbloom_wreathweaver_b160() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Despairfeeder (b160) — {3}{B} 3/4 Plant Warlock.
/// Dies-trigger Drain 3 — finisher death swing.
pub fn witherbloom_despairfeeder_b160() -> CardDefinition {
    CardDefinition {
...
/// Pest Vinetiller (b160) — {1}{G} 2/2 Pest Druid.
/// Magecraft Scry 1.
pub fn pest_vinetiller_b160() -> CardDefinition {
    use crate::effect::shortcut::magecraft_scry;
    CardDefinition {
...
/// Witherbloom Vinepetal (b160) — {1}{B}{G} Instant.
/// Drain 2 + Draw 1.
pub fn witherbloom_vinepetal_b160() -> CardDefinition {
    use crate::effect::shortcut::drain_and_draw;
    CardDefinition {
...
/// Witherbloom Drainspore (b160) — {1}{B} 2/2 Plant Warlock.
/// Magecraft each opp loses 1 life.
pub fn witherbloom_drainspore_b160() -> CardDefinition {
    CardDefinition {
...
/// Pest Tilledigger (b160) — {3}{B}{G} 4/4 Pest Beast Deathtouch.
/// 5-mana finisher.
pub fn pest_tilledigger_b160() -> CardDefinition {
    CardDefinition {
...
// ── Batch 161 (modern_decks) — More Witherbloom ───────────────────────────

/// Witherbloom Vinekeeper (b161) — {1}{G} 1/3 Plant Druid.
/// Magecraft GainLife 1 + add a +1/+1 counter on self (snowball).
pub fn witherbloom_vinekeeper_b161() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinebound (b161) — {2}{B}{G} 4/3 Plant Beast.
/// 4-mana big body.
pub fn witherbloom_vinebound_b161() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapwarden (b161) — {1}{G} 2/1 Plant Druid Reach.
/// Cheap anti-flier.
pub fn witherbloom_sapwarden_b161() -> CardDefinition {
    CardDefinition {
...
/// Pest Crawler (b161) — {B} 1/1 Pest.
/// 1-mana cheap chump-blocker.
pub fn pest_crawler_b161() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainmage (b161) — {B}{G} 2/1 Plant Warlock.
/// ETB: Drain 1.
pub fn witherbloom_drainmage_b161() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Soulgift (b161) — {1}{B} Sorcery.
/// Drain 2 + mill 2.
pub fn witherbloom_soulgift_b161() -> CardDefinition {
    CardDefinition {
...
// ── Batch 162 (modern_decks) — More Witherbloom ───────────────────────────

/// Pest Stranglechoke (b162) — {2}{B}{G} 3/3 Pest Plant.
/// On dies → drain 2.
pub fn pest_stranglechoke_b162() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mosskeeper (b162) — {2}{G} 2/3 Plant Druid Reach.
/// Magecraft gain 2 life.
pub fn witherbloom_mosskeeper_b162() -> CardDefinition {
    CardDefinition {
...
/// Pest Trampler (b162) — {3}{G} 4/4 Pest Beast Trample.
/// 4-mana big body.
pub fn pest_trampler_b162() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinetwine (b162) — {1}{B}{G} Sorcery.
/// Drain 3 + each player mills 2.
pub fn witherbloom_vinetwine_b162() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestsower (b162) — {3}{B}{G} 3/4 Plant Warlock.
/// ETB: mint 2 Pest tokens + drain 1.
pub fn witherbloom_pestsower_b162() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapseer (b162) — {1}{G} 1/2 Plant Druid.
/// Magecraft: Scry 1.
pub fn witherbloom_sapseer_b162() -> CardDefinition {
    use crate::effect::shortcut::magecraft_scry;
    CardDefinition {
...
// ── Batch 164 (modern_decks) — More Witherbloom ───────────────────────────

/// Witherbloom Vinemender (b164) — {1}{G} 1/3 Plant Druid Reach.
/// ETB: gain 2 life.
pub fn witherbloom_vinemender_b164() -> CardDefinition {
    CardDefinition {
...
/// Pest Vinelasher (b164) — {1}{B}{G} 2/3 Pest Plant.
/// On dies: drain 1.
pub fn pest_vinelasher_b164() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Marshchoke (b164) — {2}{B}{G} Sorcery.
/// Destroy target creature with power ≤ 3, gain 2 life.
pub fn witherbloom_marshchoke_b164() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestcoach (b164) — {2}{B}{G} 3/3 Plant Warlock.
/// ETB: mint 1 Pest; Magecraft: drain 1.
pub fn witherbloom_pestcoach_b164() -> CardDefinition {
...
/// Pest Spawnking (b164) — {3}{B}{G} 3/4 Pest Beast.
/// ETB: mint 2 Pest tokens.
pub fn pest_spawnking_b164() -> CardDefinition {
    use crate::effect::shortcut::mint_pests;
    CardDefinition {
...
/// Witherbloom Researcher (b164) — {1}{B} 1/2 Human Warlock.
/// Magecraft: each opp loses 1 life and you gain 1.
pub fn witherbloom_researcher_b164() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Loamspeaker (b164) — {2}{G} 2/3 Plant Druid.
/// Magecraft: put a +1/+1 counter on this creature.
pub fn witherbloom_loamspeaker_b164() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Killweave (b164) — {2}{B} Instant.
/// Target creature gets -2/-2 EOT.
pub fn witherbloom_killweave_b164() -> CardDefinition {
    CardDefinition {
...
// ── Batch 165 (modern_decks) — More Witherbloom ───────────────────────────

/// Pest Deathbloom (b165) — {2}{B}{G} 3/2 Pest Plant Deathtouch.
pub fn pest_deathbloom_b165() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Witchlight (b165) — {1}{B}{G} Sorcery.
/// Drain 2 + draw 1.
pub fn witherbloom_witchlight_b165() -> CardDefinition {
    use crate::effect::shortcut::drain_and_draw;
    CardDefinition {
...
/// Witherbloom Rootguard (b165) — {2}{G} 2/4 Plant Druid Reach.
/// Defensive reach body.
pub fn witherbloom_rootguard_b165() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestkeeper (b165) — {1}{B} 1/1 Pest Warlock.
/// When dies: mint 1 Pest token.
pub fn witherbloom_pestkeeper_b165() -> CardDefinition {
    use crate::effect::shortcut::dies_mint_pest;
    CardDefinition {
...
/// Witherbloom Lifesurge (b165) — {2}{B}{G} Instant.
/// Drain 3.
pub fn witherbloom_lifesurge_b165() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Deathcoach (b165) — {3}{B}{G} 4/4 Plant Warlock Trample.
/// ETB: mill self 2.
pub fn witherbloom_deathcoach_b165() -> CardDefinition {
    CardDefinition {
...
// ── Batch 166 (modern_decks) — Witherbloom cycle ──────────────────────────
//
// Ten new Witherbloom (B/G) cards: a mix of Pest bodies, drain payoffs,
// magecraft drain, and graveyard recursion. All compose against
// existing shortcuts; no engine changes required.

/// Witherbloom Vinegrowth (b166) — {1}{G} 1/2 Plant Druid.
/// ETB: target friendly creature gets +1/+1 EOT + magecraft self-pump.
pub fn witherbloom_vinegrowth_b166() -> CardDefinition {
    CardDefinition {
...
/// Pest Bloomling (b166) — {B}{G} 2/2 Pest.
/// Dies → gain 1 life (Pest die rider, even though this isn't a Pest token).
pub fn pest_bloomling_b166() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapripper (b166) — {2}{B} 2/3 Plant Warlock.
/// ETB drain 1 — defensive drain body.
pub fn witherbloom_sapripper_b166() -> CardDefinition {
    CardDefinition {
...
/// Pest Bestiary (b166) — {2}{B}{G} Sorcery.
/// Mints two Pest tokens.
pub fn pest_bestiary_b166() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Devouring Vines (b166) — {1}{B} Instant.
/// Target creature gets -2/-2 EOT.
pub fn witherbloom_devouring_vines_b166() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Lifesong (b166) — {1}{B}{G} Instant.
/// Drain 1 + gain 2 life (3 total life swing).
pub fn witherbloom_lifesong_b166() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapworm (b166) — {2}{G} 2/3 Plant Insect Deathtouch.
/// Defensive deathtouch body.
pub fn witherbloom_sapworm_b166() -> CardDefinition {
    CardDefinition {
...
/// Pest Reborn (b166) — {3}{B} Sorcery.
/// Return target creature card from your gy → hand + mint a Pest token.
pub fn pest_reborn_b166() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainmancer (b166) — {2}{B}{G} 3/3 Human Warlock.
/// Magecraft drain 1 each opp — Apprentice on a 4-mana frame.
pub fn witherbloom_drainmancer_b166() -> CardDefinition {
    CardDefinition {
...
/// Pest Devotee (b166) — {2}{B}{G} 3/2 Pest Warlock Lifelink.
/// 4-mana lifelink Pest finisher.
pub fn pest_devotee_b166() -> CardDefinition {
    CardDefinition {
...
//
// Five more Witherbloom cards including a finality-counter granter.

/// Witherbloom Hex (b167) — {1}{B}{G} Instant.
/// Put a finality counter on target creature (CR 122.1h granter).
pub fn witherbloom_hex_b167() -> CardDefinition {
    use crate::card::CounterType;
    use crate::effect::shortcut::target_filtered;
    CardDefinition {
...
/// Witherbloom Drainshepherd (b167) — {3}{B}{G} 3/4 Plant Warlock.
/// "Whenever you gain life, each opponent loses 1 life."
pub fn witherbloom_drainshepherd_b167() -> CardDefinition {
    CardDefinition {
...
/// Pest Sentry (b167) — {1}{G} 2/2 Pest Warrior Vigilance.
/// Cheap vigilant Pest body.
pub fn pest_sentry_b167() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestbringer (b167) — {3}{B}{G} Sorcery.
/// Mint three Pest tokens.
pub fn witherbloom_pestbringer_b167() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mossguard (b167) — {2}{G} 3/3 Plant Beast Trample.
/// Vanilla green trampler.
pub fn witherbloom_mossguard_b167() -> CardDefinition {
    CardDefinition {
...
// ── Batch 174 (modern_decks) — additional Witherbloom cards ───────────────

/// Witherbloom Pestbinder (b174) — {1}{B} 2/2 Human Druid.
/// Magecraft: each opp loses 1 life.
pub fn witherbloom_pestbinder_b174() -> CardDefinition {
    CardDefinition {
...
/// Pest Shepherd (b174) — {2}{G} 2/3 Human Druid.
/// ETB: create a Pest token.
pub fn pest_shepherd_b174() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainmage (b174) — {2}{B}{G} 3/3 Vampire Warlock.
/// ETB: drain 2. Magecraft: gain 1 life.
pub fn witherbloom_drainmage_b174() -> CardDefinition {
    CardDefinition {
...
/// Pest Bramblebeast (b174) — {3}{G} 4/4 Beast.
/// Hardy mid-curve body. Reach.
pub fn pest_bramblebeast_b174() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Toxicultivator (b174) — {2}{B}{G} 3/2 Human Druid.
/// Whenever this creature attacks, target opp loses 2 life and you gain 2 life.
pub fn witherbloom_toxicultivator_b174() -> CardDefinition {
    CardDefinition {
...
// ── Batch 175 (modern_decks) — additional Witherbloom cards ───────────────

/// Witherbloom Cauldroncrier (b175) — {1}{B}{G} 2/3 Human Warlock.
/// Magecraft: deal 1 damage to target opp; gain 1 life.
pub fn witherbloom_cauldroncrier_b175() -> CardDefinition {
...
/// Witherbloom Pestharvest (b175) — {2}{B}{G} Sorcery.
/// Create two Pest tokens.
pub fn witherbloom_pestharvest_b175() -> CardDefinition {
    CardDefinition {
...
/// ETB: mints a Pest token + magecraft self-pump +1/+1 EOT.
pub fn witherbloom_brewer_b187() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Toxinbloom (b187) — {1}{B} Sorcery.
/// Target creature gets -2/-2 EOT. Drain 1.
pub fn witherbloom_toxinbloom_b187() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Hexblossom (b187) — {2}{B}{G} Sorcery.
/// Put a deathtouch counter on target creature you control + mint a Pest.
pub fn witherbloom_hexblossom_b187() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Lifeknotter (b187) — {2}{B}{G} 3/3 Plant Warlock.
/// Each time you gain life, each opp loses 1 (lifegain chain payoff). Note:
/// this is intentionally LoseLife (not Drain) to avoid an infinite trigger
/// loop with the Lifeknotter's own life-gain causing it to retrigger.
pub fn witherbloom_lifeknotter_b187() -> CardDefinition {
    CardDefinition {
...
/// Pest Mauler (b187) — {2}{B} 2/2 Pest with Menace.
/// Combat damage to player → drain 1.
pub fn pest_mauler_b187() -> CardDefinition {
    use crate::effect::shortcut::on_attack;
    let _ = on_attack;
    CardDefinition {
...
/// Witherbloom Grovecaller (b187) — {B}{G} 2/2 Plant Druid Reach.
/// Magecraft: each opp loses 1.
pub fn witherbloom_grovecaller_b187() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Soulreaper (b187) — {3}{B}{G} 4/3 Vampire Warlock.
/// ETB: each opponent loses 2 life. Whenever another creature you control
/// dies, gain 1 life.
pub fn witherbloom_soulreaper_b187() -> CardDefinition {
    CardDefinition {
...
/// ETB: gain 1 life.
pub fn witherbloom_vinecaster_b178() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Cauldron-Echo (b178) — {2}{B}{G} Instant. Drain 3.
pub fn witherbloom_cauldron_echo_b178() -> CardDefinition {
    use crate::effect::shortcut::drain;
    CardDefinition {
...
// ── Batch 176 (modern_decks) — engine-improvement-driven Witherbloom ──────

/// Witherbloom Doomsign (b176) — {2}{B} Sorcery.
/// Put a finality counter on target creature, then deal 1 damage to that creature.
pub fn witherbloom_doomsign_b176() -> CardDefinition {
    use crate::effect::shortcut::target_filtered;
    CardDefinition {
...
/// Witherbloom Pestmaster (b175) — {3}{B}{G} 3/4 Human Druid.
/// When another creature you control dies, create a Pest token.
pub fn witherbloom_pestmaster_b175() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapcaller (b174) — {2}{G} 2/4 Human Druid.
/// Magecraft: gain 1 life.
pub fn witherbloom_sapcaller_b174() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestlord II (b192) — {2}{B}{G} 3/3 Plant Warlock.
/// ETB: create a Pest token. Whenever another creature you control dies,
/// you gain 1 life. (Pest tribal payoff.)
pub fn witherbloom_pestlord_ii_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinekeeper (b192) — {1}{G} 1/3 Plant Druid Vigilance.
/// Magecraft: gain 1 life.
pub fn witherbloom_vinekeeper_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Deathmark (b192) — {1}{B} Sorcery.
/// Destroy target creature. You lose 1 life.
pub fn witherbloom_deathmark_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestkin (b192) — {B} 1/1 Pest creature with deathtouch.
/// "When it dies, you gain 1 life." (Pest tribal cheap body.)
pub fn witherbloom_pestkin_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapoozer (b192) — {2}{G} 2/3 Ooze.
/// Magecraft: target creature gets +1/+1 EOT.
pub fn witherbloom_sapoozer_b192() -> CardDefinition {
...
/// Witherbloom Soulgift (b192) — {1}{B}{G} Sorcery.
/// Drain 2 + create a Pest token. (Drain pattern with reach via Pest body.)
pub fn witherbloom_soulgift_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mossherd (b192) — {3}{G} 4/4 Plant Beast Trample.
/// Vanilla curve filler with trample for Witherbloom green ramp.
pub fn witherbloom_mossherd_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainwell (b192) — {3}{B} Sorcery.
/// Drain 4 (each opponent loses 4, you gain 4).
pub fn witherbloom_drainwell_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestsworn (b192) — {2}{B} 3/2 Human Warlock.
/// ETB: create a Pest token. When this creature dies, drain 1.
pub fn witherbloom_pestsworn_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Earthcaller (b192) — {2}{G} 2/2 Human Druid.
/// Magecraft: put a +1/+1 counter on this creature.
pub fn witherbloom_earthcaller_b192() -> CardDefinition {
    use crate::effect::shortcut::magecraft_add_counter_self;
    CardDefinition {
...
/// Witherbloom Cryptcaller (b192) — {3}{B} 3/3 Human Warlock.
/// ETB: each opponent loses 2 life. Magecraft: each opp loses 1.
pub fn witherbloom_cryptcaller_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Greenrot (b192) — {3}{G} Sorcery.
/// Target creature gets a trample counter and a +1/+1 counter.
/// (CR 122.1b keyword counter exerciser.)
pub fn witherbloom_greenrot_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestmage (b192) — {1}{B} 2/1 Human Warlock.
/// Magecraft: create a Pest token. (Magecraft tribal flood.)
pub fn witherbloom_pestmage_b192() -> CardDefinition {
    use crate::effect::shortcut::magecraft_mint_pest;
    CardDefinition {
...
/// Witherbloom Lifeshroud (b192) — {2}{G}{G} 3/4 Plant Druid Hexproof.
/// Vanilla beater with hexproof.
pub fn witherbloom_lifeshroud_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Reaper (b192) — {3}{B}{G} 4/4 Plant Warlock.
/// ETB: destroy target creature an opponent controls.
pub fn witherbloom_reaper_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestcaller II (b192) — {2}{B} 2/2 Human Warlock.
/// On attack: create a Pest token (Pest aggro engine).
pub fn witherbloom_pestcaller_ii_b192() -> CardDefinition {
    use crate::effect::shortcut::on_attack_create_token;
    CardDefinition {
...
/// Witherbloom Healscribe (b192) — {2}{B}{G} 2/3 Human Druid Lifelink.
/// Magecraft: gain 2 life.
pub fn witherbloom_healscribe_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapdrain (b192) — {2}{B}{G} Sorcery.
/// Drain 3 and gain 1 additional life if you control a Pest.
/// (For now collapses to drain 3 + create Pest as a synergy proxy.)
pub fn witherbloom_sapdrain_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Brutalist (b192) — {B}{B} 3/2 Vampire Warlock Menace.
/// "When this dies, drain 2."
pub fn witherbloom_brutalist_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Treetender (b192) — {2}{G} 2/3 Plant Druid.
/// Magecraft: target creature gets a +1/+1 counter.
pub fn witherbloom_treetender_b192() -> CardDefinition {
...
/// Witherbloom Boscage (b192) — {1}{G} Instant.
/// Target creature gets +3/+3 EOT and trample EOT.
pub fn witherbloom_boscage_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Recollector (b192) — {3}{B} 3/3 Vampire Warlock.
/// ETB: return a creature card from your graveyard to your hand.
pub fn witherbloom_recollector_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Witchwarden (b192) — {1}{B}{G} 2/2 Plant Warlock Reach.
/// Magecraft: each opponent loses 1 life and you gain 1 life.
pub fn witherbloom_witchwarden_b192() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mosshenge (b192) — {2}{G}{G} 4/5 Plant Beast Reach.
/// Solid mid-curve Witherbloom green wall — Reach + meaty body.
pub fn witherbloom_mosshenge_b192() -> CardDefinition {
    CardDefinition {
...
// ── Batch 194 (modern_decks) — Witherbloom B/G compact additions ──────────

/// Witherbloom Pestswarmer (b194) — {3}{B}{G} 3/4 Plant Warlock.
/// ETB: create 2 Pest tokens.
pub fn witherbloom_pestswarmer_b194() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Smolderscholar (b194) — {1}{B} 1/2 Human Warlock.
/// Magecraft: drain target opponent for 1 (collapses to drain each opp).
pub fn witherbloom_smolderscholar_b194() -> CardDefinition {
    use crate::effect::shortcut::magecraft_drain;
    CardDefinition {
...
/// Witherbloom Lifeshare (b194) — {1}{G} Sorcery.
/// Gain 3 life.
pub fn witherbloom_lifeshare_b194() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapsage (b194) — {2}{G}{G} 3/3 Plant Druid.
/// ETB: gain 3 life. Magecraft: gain 1 life.
pub fn witherbloom_sapsage_b194() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Tombsworn (b194) — {3}{B} 4/3 Vampire Warlock.
/// Vanilla 4/3 for {3}{B}: above-rate body.
pub fn witherbloom_tombsworn_b194() -> CardDefinition {
    CardDefinition {
...
// ── Batch 195 (modern_decks) — Witherbloom B/G more deep cuts ─────────────

/// Witherbloom Quagsage (b195) — {2}{G} 3/2 Plant Druid.
/// On other dies (controlled): drain 1 (Pest tribal payoff).
pub fn witherbloom_quagsage_b195() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestrune (b195) — {1}{B}{G} 2/2 Plant Warlock.
/// ETB: gain 2 life and create a Pest token.
pub fn witherbloom_pestrune_b195() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Hexshroud (b195) — {2}{B}{B} 3/3 Vampire Warlock Hexproof.
/// Beefy Vampire body with hexproof.
pub fn witherbloom_hexshroud_b195() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Veinblossom (b195) — {2}{B}{G} Sorcery.
/// Drain 2 + each opponent loses 1 life.
pub fn witherbloom_veinblossom_b195() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Lifedrinker (b195) — {1}{B} 1/2 Vampire Warlock Lifelink.
/// Cheap lifelink body.
pub fn witherbloom_lifedrinker_b195() -> CardDefinition {
    CardDefinition {
...
// ── Batch 196 (modern_decks) — Witherbloom more variety ──────────────────

/// Witherbloom Soulkeeper (b196) — {2}{B} 2/3 Spirit Warlock.
/// Magecraft: gain 1 life and create a Pest token.
pub fn witherbloom_soulkeeper_b196() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapworm (b196) — {1}{G} 1/2 Snake Deathtouch.
/// Cheap green deathtouch body.
pub fn witherbloom_sapworm_b196() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Earthrend (b196) — {2}{G} Sorcery.
/// Target creature gets +2/+2 and gains trample until end of turn.
pub fn witherbloom_earthrend_b196() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainslayer (b196) — {3}{B}{G} 3/3 Warlock.
/// When this creature attacks: drain 2.
pub fn witherbloom_drainslayer_b196() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestcarver (b196) — {3}{B}{G} 4/3 Plant Warlock.
/// ETB: create a Pest token. Magecraft: each opponent loses 1 life.
pub fn witherbloom_pestcarver_b196() -> CardDefinition {
    CardDefinition {
...
// ── Batch 198 (modern_decks) — Witherbloom (B/G) extension ───────────────

/// Witherbloom Stem (b198) — {G} 1/2 Plant Druid.
/// Vanilla green one-drop.
pub fn witherbloom_stem_b198() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drinker (b198) — {1}{B} 2/2 Vampire Warlock Lifelink.
/// Aggressive 2-drop lifelink body.
pub fn witherbloom_drinker_b198() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pesthatcher (b198) — {2}{B} 1/1 Plant Warlock.
/// ETB mints a Pest token.
pub fn witherbloom_pesthatcher_b198() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinewright (b198) — {2}{G} 3/3 Plant Druid.
/// Vanilla above-rate green body.
pub fn witherbloom_vinewright_b198() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainwitch (b198) — {B}{G} 2/2 Human Warlock.
/// Magecraft drain 1 (Apprentice template at a different stat-line).
pub fn witherbloom_drainwitch_b198() -> CardDefinition {
    use crate::effect::shortcut::magecraft_drain;
    CardDefinition {
...
/// Witherbloom Curse (b198) — {1}{B} Instant.
/// Target creature gets -2/-2 EOT.
pub fn witherbloom_curse_b198() -> CardDefinition {
    CardDefinition {
...
/// Pestcaller's Hex (b198) — {3}{B}{G} Sorcery.
/// Create 2 Pest tokens.
pub fn pestcallers_hex_b198() -> CardDefinition {
    use crate::effect::shortcut::mint_pests;
    CardDefinition {
...
/// Witherbloom Behemoth (b198) — {4}{B}{G} 5/5 Plant Beast Trample.
/// Curve-topper.
pub fn witherbloom_behemoth_b198() -> CardDefinition {
    CardDefinition {
...
// ── Batch 199 (modern_decks) — Witherbloom rounding-out ──────────────────

/// Witherbloom Shambler (b199) — {1}{G} 2/2 Plant Beast.
/// Vanilla 2-drop body.
pub fn witherbloom_shambler_b199() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapphire (b199) — {2}{G} Sorcery.
/// Put two +1/+1 counters on target creature you control.
pub fn witherbloom_sapphire_b199() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Tendril (b199) — {2}{B} 2/3 Vampire Warlock Lifelink.
/// Mid-game lifelinker.
pub fn witherbloom_tendril_b199() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Poisonkin (b199) — {1}{B}{G} 2/2 Plant Warlock Deathtouch.
/// Compact deathtouch body.
pub fn witherbloom_poisonkin_b199() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Reverence (b199) — {B} Instant.
/// Target creature gets -1/-1 EOT.
pub fn witherbloom_reverence_b199() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestcaller (b202) — {2}{B}{G} 2/2 Human Druid.
/// ETB: create two 1/1 B/G Pest tokens with the death-life rider.
pub fn witherbloom_pestcaller_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sapdraw (b202) — {B}{G} Sorcery.
/// Each opponent loses 2 life. You gain 2 life. Draw a card.
pub fn witherbloom_sapdraw_b202() -> CardDefinition {
    CardDefinition {
...
/// Pest Devourer (b202) — {1}{B}{G} 2/2 Pest.
/// Whenever another Pest you control dies, this creature gets a +1/+1
/// counter. Aristocrat-style Pest payoff.
pub fn pest_devourer_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Vinepath (b202) — {2}{G} Sorcery.
/// Put two +1/+1 counters on target creature you control. Then surveil 1.
pub fn witherbloom_vinepath_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mossblossom (b202) — {1}{G} 2/3 Plant Druid.
/// ETB: gain 2 life. Defender + body for blockingdrooled.
pub fn witherbloom_mossblossom_b202() -> CardDefinition {
    CardDefinition {
...
/// Pestshell Crusader (b202) — {2}{B}{G} 3/3 Pest Knight.
/// Trample. ETB drain 1. Aggressive trampler with rider.
pub fn pestshell_crusader_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Spellbloom (b202) — {1}{B}{G} 2/2 Plant Druid.
/// Magecraft: put a +1/+1 counter on this creature.
pub fn witherbloom_spellbloom_b202() -> CardDefinition {
    use crate::effect::shortcut::magecraft_add_counter_self;
    CardDefinition {
...
/// Witherbloom Famine (b202) — {3}{B}{B} Sorcery.
/// Each opponent loses 4 life. You gain 4 life.
pub fn witherbloom_famine_b202() -> CardDefinition {
    CardDefinition {
...
/// Pest Howler (b202) — {1}{B} 1/1 Pest.
/// On attack: each opponent loses 1 life. Aggressive Pest with rider.
pub fn pest_howler_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Cultivator (b202) — {2}{G} 2/3 Human Druid.
/// {T}: Add {B} or {G}. Mana ramp body.
pub fn witherbloom_cultivator_b202() -> CardDefinition {
...
/// Witherbloom Decompose (b202) — {1}{B} Instant.
/// Destroy target creature with toughness 2 or less.
pub fn witherbloom_decompose_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Briarcaller (b202) — {3}{B}{G} 4/4 Plant Beast.
/// Trample, Reach. Big-body finisher.
pub fn witherbloom_briarcaller_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Rotcaller (b202) — {2}{B} 2/3 Vampire Warlock.
/// ETB: target opponent discards a card.
pub fn witherbloom_rotcaller_b202() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Verdance (b202) — {2}{G} Sorcery.
/// Create a 4/4 G Beast token.
pub fn witherbloom_verdance_b202() -> CardDefinition {
...
// ── Batch 203 (modern_decks) — Witherbloom compact round ─────────────────

/// Witherbloom Apprentice II (b203) — {B}{G} 2/2 Human Warlock.
/// Magecraft drain 1 (same as the original Apprentice; mirrors the
/// shape for synth-deck symmetry).
pub fn witherbloom_apprentice_ii_b203() -> CardDefinition {
    CardDefinition {
...
/// Pest Tendril (b203) — {1}{B}{G} Sorcery. Each opp loses 4, you gain 4.
pub fn pest_tendril_b203() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Tutor (b203) — {1}{G} 1/2 Human Druid.
/// {2}{G}, {T}: search your library for a basic land, put it in hand, shuffle.
pub fn witherbloom_tutor_b203() -> CardDefinition {
    use crate::card::ActivatedAbility;
    CardDefinition {
...
/// Pest Sapper (b203) — {1}{B} 1/1 Pest. Dies → opp loses 2 life.
pub fn pest_sapper_b203() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Apprentice III (b203) — {1}{B}{G} 2/3 Human Druid.
/// Magecraft self-pump +1/+1 EOT.
pub fn witherbloom_apprentice_iii_b203() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Pestlord (b203) — {3}{B}{G} 4/5 Demon. Trample.
/// Race-breaker top-end body.
pub fn witherbloom_pestlord_b203() -> CardDefinition {
    CardDefinition {
...
/// Pest Patriarch (b203) — {2}{B}{G} 3/3 Pest Warrior. ETB mint a Pest token.
pub fn pest_patriarch_b203() -> CardDefinition {
    CardDefinition {
...
// ── Batch 204 (modern_decks) — Witherbloom round 4 ───────────────────────

/// Pest Mauler (b204) — {1}{B}{G} 3/3 Pest Beast. Trample. Aggressive Pest.
pub fn pest_mauler_b204() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Drainshade (b204) — {2}{B} 2/2 Vampire. ETB drain 2.
pub fn witherbloom_drainshade_b204() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Bloodtap (b204) — {2}{B}{G} Instant. Drain 5.
pub fn witherbloom_bloodtap_b204() -> CardDefinition {
    CardDefinition {
...
/// Pest Devourer II (b204) — {3}{B}{G} 4/4 Pest. Deathtouch.
pub fn pest_devourer_ii_b204() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Mauler (b204) — {3}{G} 4/3 Druid Beast.
/// Trample. Big body for Witherbloom shells.
pub fn witherbloom_mauler_b204() -> CardDefinition {
    CardDefinition {
...
// ─────────────────────────────────────────────────────────────────────────
// Batch 206 (modern_decks) — Witherbloom (B/G) staples.
// ─────────────────────────────────────────────────────────────────────────

/// Witherbloom Grim Harvest (b206) — {2}{B}{G} Sorcery.
/// Each opponent loses 4 life and you gain 4 life.
pub fn witherbloom_grim_harvest_b206() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Sporecaller (b206) — {1}{B}{G} 2/2 Fungus Druid.
/// Whenever another creature you control dies, you gain 1 life.
pub fn witherbloom_sporecaller_b206() -> CardDefinition {
    CardDefinition {
...
/// Witherbloom Fungalbeast (b206) — {3}{G} 3/4 Fungus Beast.
/// ETB — you gain 2 life.
pub fn witherbloom_fungalbeast_b206() -> CardDefinition {
    CardDefinition {
