...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Nature's Vengeance (C18, Gyrus, Waker of Corpses, 18; `011A87o2`, 2026-09-24 14:21 UTC — yielded Death Toll to `01546QdT`, who claimed first).** **Family Matters (BLC, Zinnia, Valley's Voice, 19; `01XnuL2a`, 2026-09-24 run 4).** **Draconic Domination (C17, The Ur-Dragon, 18; `015cKV6u`, 2026-09-24 run 5).** **20 Ways to Win (SLD, 16; `01StaUuo`, 2026-09-24 run 6) — ⚠ ALREADY LANDED as seat 92 by `01546QdT` (claimed 19:30, landed before this claim); drop it.** **Temur Roar (TDC, Eshki Dragonclaw, 13; `018BnccM`, 2026-09-24 run 2).** **Cabaretti Cacophony (NCC, Kitt Kanto, Mayhem Diva, 16; `01546QdT`, 2026-09-24 21:20).** Claim in this line, pushed on its own, before starting a list.
