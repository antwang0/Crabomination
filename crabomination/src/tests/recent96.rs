...
fn jukai_naturalist_discounts_enchantments() {
    ...
    let ench = crate::card::CardInstance::new(g.next_id(), catalog::golden_tail_disciple(), 0);
...
fn ironhoof_boar_channel_pumps() {
    ...
    g.perform_action(GameAction::ActivateAbility {
        card_id: boar, ability_index: 0, target: Some(crate::game::types::Target::Permanent(bear)),
...
fn colossal_skyturtle_channel_bounces() {
    ...
    g.perform_action(GameAction::ActivateAbility {
        card_id: turtle, ability_index: 1, target: Some(crate::game::types::Target::Permanent(foe)),
        additional_targets: Vec::new(), x_value: None,
