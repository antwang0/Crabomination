...
use crate::card::{
    ...
    EventScope, EventSpec, Keyword, SelectionRequirement, Selector, StaticAbility, Subtypes,
...
pub fn sentinel_of_the_nameless_city() -> CardDefinition {
    ...
    let make_map = || Effect::CreateToken {
        who: PlayerRef::You,
        count: Value::Const(1),
        definition: std::sync::Arc::new(map_token()),
    };
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::Seq(vec![
                Effect::CreateToken {
                    who: PlayerRef::You,
                    count: Value::Const(1),
                    definition: std::sync::Arc::new(blood_token()),
                },
                Effect::ForEach {
...
pub fn ichorid() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::MayDo {
                description: "Exile a black creature card from your graveyard to return Ichorid?"
                    .into(),
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::Seq(vec![
                Effect::CreateToken {
                    who: PlayerRef::You,
                    count: Value::Const(1),
                    definition: std::sync::Arc::new(wurm_deathtouch),
                },
                Effect::CreateToken {
                    who: PlayerRef::You,
                    count: Value::Const(1),
                    definition: std::sync::Arc::new(wurm_lifelink),
                },
            ]),
        }],
        ..Default::default()
...
pub fn vengevine() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::MayDo {
                description: "Return Vengevine from your graveyard to the battlefield.".to_string(),
                body: Box::new(Effect::Move {
                    what: Selector::This,
                    to: ZoneDest::Battlefield {
                        controller: PlayerRef::You,
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: std::sync::Arc::new(coil),
            },
        }],
        activated_abilities: vec![ActivatedAbility {
            energy_cost: 0,
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::MayDo {
                ...
                body: Box::new(Effect::CreateToken {
                    who: PlayerRef::You,
                    count: Value::Const(1),
                    definition: std::sync::Arc::new(spawn),
                }),
            },
        }],
        ..Default::default()
...
pub fn ainok_survivalist() -> CardDefinition {
    ...
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Dog, CreatureType::Shaman],
            ..Default::default()
        },
        power: 2,
        toughness: 1,
...
pub fn goldmeadow_harrier() -> CardDefinition {
    tapper_1_1(
        "Goldmeadow Harrier",
        vec![CreatureType::Kithkin, CreatureType::Soldier],
    )
}
...
pub fn ohran_frostfang() -> CardDefinition {
    use crate::card::{
        EventKind, EventScope, EventSpec, StaticAbility, Supertype, TriggeredAbility,
    };
    use crate::effect::StaticEffect;
    CardDefinition {
...
pub fn kodama_of_the_west_tree() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::Search {
                who: PlayerRef::You,
                filter: SelectionRequirement::Land.and(SelectionRequirement::HasSupertype(
                    crate::card::Supertype::Basic,
                )),
                to: ZoneDest::Battlefield {
                    controller: PlayerRef::You,
                    tapped: true,
...
pub fn apex_hawks() -> CardDefinition {
    CardDefinition {
        ...
        keywords: vec![
            Keyword::Flying,
            Keyword::Multikicker(cost(&[generic(1), w()])),
        ],
...
pub fn skitter_of_lizards() -> CardDefinition {
    CardDefinition {
        ...
        keywords: vec![
            Keyword::Haste,
            Keyword::Multikicker(cost(&[generic(1), r()])),
        ],
        enters_with_counters: Some((CounterType::PlusOnePlusOne, Value::TimesKicked)),
        ..Default::default()
    }
...
pub fn wight_of_precinct_six() -> CardDefinition {
    ...
    CardDefinition {
        ...
        power: 1,
        toughness: 1,
        dynamic_pt: Some(DynamicPt::BasePlusOpponentGraveyards {
            base: 1,
            creatures_only: true,
        }),
        ..Default::default()
...
pub fn fleshwrither() -> CardDefinition {
    CardDefinition {
        ...
        power: 3,
        toughness: 3,
        activated_abilities: vec![crate::effect::shortcut::transfigure(cost(&[
            generic(1),
            b(),
            b(),
        ]))],
