...
// ── Batch 204 (modern_decks) — Lorehold round 4 ──────────────────────────

/// Lorehold Battlemage (b204) — {2}{R}{W} 3/3 Spirit Cleric.
/// On attack: deal 1 damage to any target.
pub fn lorehold_battlemage_b204() -> CardDefinition {
    use crate::effect::shortcut::on_attack_ping_any;
    CardDefinition {
...
/// Lorehold Pyromaster (b204) — {3}{R} 4/3 Human Wizard.
/// Magecraft ping 2.
pub fn lorehold_pyromaster_b204() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Ardent (b204) — {R}{W} 2/2 Spirit. First strike. Haste.
pub fn lorehold_ardent_b204() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Flameburst (b204) — {2}{R} Sorcery. Deal 4 to any target.
pub fn lorehold_flameburst_b204() -> CardDefinition {
    use crate::effect::shortcut::target_any;
    CardDefinition {
...
/// Lorehold Spiritbringer (b204) — {3}{R}{W} 3/3 Spirit Cleric.
/// ETB mint a Lorehold spirit token.
pub fn lorehold_spiritbringer_b204() -> CardDefinition {
    CardDefinition {
...
// ─────────────────────────────────────────────────────────────────────────
// Batch 206 (modern_decks) — Lorehold (R/W) staples.
// ─────────────────────────────────────────────────────────────────────────

/// Lorehold Skirmisher (b206) — {1}{R} 2/2 Spirit Soldier.
/// Whenever this creature attacks, it deals 1 damage to any target.
pub fn lorehold_skirmisher_b206() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Archivekeeper (b206) — {2}{W} 2/4 Spirit Cleric.
/// ETB — draw a card.
pub fn lorehold_archivekeeper_b206() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Ember Veteran (b206) — {3}{R}{W} 4/4 Spirit Warrior, Trample.
/// Magecraft — whenever you cast or copy an instant or sorcery, this
/// creature gets +1/+0 until end of turn.
pub fn lorehold_ember_veteran_b206() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Soulkindler (b207) — {2}{R}{W} 3/3 Spirit Cleric.
/// When this creature enters, create a 2/2 R/W Spirit with flying.
pub fn lorehold_soulkindler_b207() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Cinderscribe (b207) — {1}{R} 2/1 Human Wizard.
/// Magecraft — this creature deals 1 damage to any target.
pub fn lorehold_cinderscribe_b207() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Battlecaller (b207) — {2}{W} 2/3 Spirit Soldier.
/// Whenever this creature attacks, create a 2/2 R/W Spirit with flying.
pub fn lorehold_battlecaller_b207() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Emberbolt (b207) — {1}{R} Instant.
/// Deal 3 damage to any target.
pub fn lorehold_emberbolt_b207() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Relicsmith (b207) — {3}{W} 3/4 Spirit Artificer.
/// When this creature enters, return target creature card with mana value
/// 3 or less from your graveyard to your hand.
pub fn lorehold_relicsmith_b207() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Charge II (b207) — {1}{R}{W} Sorcery.
/// Creatures you control get +1/+0 and gain first strike until end of turn.
pub fn lorehold_charge_ii_b207() -> CardDefinition {
    CardDefinition {
...
/// Lorehold Vanguard (b207) — {2}{R}{W} 4/3 Spirit Knight, Haste.
/// A clean aggressive midrange body for the Lorehold tokens shell.
pub fn lorehold_vanguard_b207() -> CardDefinition {
    CardDefinition {
