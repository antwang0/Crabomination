...
5. **⚠ OPEN CLAIMS — don't duplicate:** Open Hostility (C16, Saskia, 16; `01XnuL2a`), Breed Lethality (C16, Atraxa, 17; `01546QdT`), Mirror Mastery (CMD, Riku, 16; `011A87o2`). **Arcane Wizardry (C17, Inalla, Archmage Ritualist, 16; `01StaUuo`, 2026-09-24 run 5).** Claim in this line, pushed on its own, before starting a list.
