...
- **recent239 (DSK/OTJ/MKM gap batch, 12 cards):** the **Survival** ability word
  ...
  Model). Composition-only: Betrayer's Bargain, Untimely Malfunction, Omnivorous
  Flytrap, Norin, Altanak, Come Back Wrong, Trial of Agony, Bite Down on Crime.
  CR 122.5 / 702.166 / 608.2b conformance tests. Tests in `tests/recent239.rs`.
