...
pub fn road_rage() -> CardDefinition {
    let mounts_and_vehicles = Selector::EachPermanent(SelectionRequirement::ControlledByYou.and(
        SelectionRequirement::HasCreatureType(CreatureType::Mount).or(
    ...
    CardDefinition {
        ...
        effect: Effect::DealDamage {
            ...
            amount: Value::Sum(vec![
                Value::Const(2),
                Value::CountOf(Box::new(mounts_and_vehicles)),
            ]),
        },
        ..Default::default()
    }
...
pub fn silken_strength() -> CardDefinition {
    CardDefinition {
        ...
        effect: Effect::Attach {
            what: Selector::This,
            to: target_filtered(creature_or_vehicle()),
        },
    ...
    CardDefinition {
        ...
        static_abilities: vec![
            StaticAbility {
                ...
                effect: StaticEffect::PumpPT {
                    applies_to: Selector::EachPermanent(SelectionRequirement::ControlledByYou.and(
                        SelectionRequirement::HasCreatureType(CreatureType::Mount).or(
                            SelectionRequirement::HasArtifactSubtype(ArtifactSubtype::Vehicle),
                        ),
                    )),
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: std::sync::Arc::new(zombie_2_2_token()),
            },
        }],
        ..Default::default()
    }
        ...
        effect: Effect::Seq(vec![
            ...
            Effect::AtEachCombatThisTurn {
                body: Box::new(Effect::Untap {
                    what: Selector::EachPermanent(
                        SelectionRequirement::Creature.and(SelectionRequirement::AttackedThisTurn),
                    ),
                    up_to: None,
                }),
            },
    ...
    CardDefinition {
        ...
        effect: Effect::Seq(vec![
            ...
            Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: std::sync::Arc::new(glimmer_token()),
            },
        ]),
        ..Default::default()
    }
...
pub fn gremlin_tamer() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: eerie(Effect::CreateToken {
            who: PlayerRef::You,
            count: Value::ONE,
            definition: std::sync::Arc::new(gremlin_token()),
        }),
        ..Default::default()
    }
}
...
pub fn fanatic_of_the_harrowing() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::Seq(vec![
            ...
            Effect::If {
                cond: Predicate::DiscardedThisEffect {
                    who: PlayerRef::You,
                },
                then: Box::new(draw(1)),
...
pub fn shroudstomper() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![etb(payoff()), crate::effect::shortcut::on_attack(payoff())],
        ..Default::default()
    }
}
...
pub fn toby_beastie_befriender() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::CreateToken {
            who: PlayerRef::You,
            count: Value::ONE,
            definition: std::sync::Arc::new(lonely_beast_token()),
        })],
        static_abilities: vec![StaticAbility {
        ...
        activated_abilities: vec![
            ...
            ActivatedAbility {
                ...
                effect: Effect::CreateToken {
                    ...
                    definition: std::sync::Arc::new(spider_2_2_token()),
                },
                ..Default::default()
            },
        ],
...
pub fn unsettling_twins() -> CardDefinition {
    CardDefinition {
        ...
        power: 2,
        toughness: 2,
        triggered_abilities: vec![etb(Effect::ManifestDread {
            who: PlayerRef::You,
        })],
        ..Default::default()
    }
...
pub fn synapse_necromage() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![crate::effect::shortcut::on_dies(Effect::CreateToken {
            who: PlayerRef::You,
            count: Value::Const(2),
            definition: std::sync::Arc::new(fungus_cant_block_token()),
        })],
        ..Default::default()
    }
}
