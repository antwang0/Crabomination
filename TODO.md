...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Creative Energy (M3C, Satya, Aetherflux Genius, 18; `015cKV6u`, 2026-09-25 run 7).** **Bedecked Brokers (NCC, Perrie, the Pulverizer, 21; `016DJoKA`, 2026-09-25 run 1).** **Explorers of the Deep (LCC, Hakbal of the Surging Soul, 21; `01TfrB1i`, 2026-09-25 run 1).** **Dance of the Elements (ECC, Ashling, the Limitless, 22; `018BnccM`, 2026-09-25 run 5).** Claim in this line, pushed on its own, before starting a list.
