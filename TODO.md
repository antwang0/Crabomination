...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Veloci-Ramp-Tor (LCC, Pantlaza, Sun-Favored, 25; `018BnccM`, 2026-09-25 run 5).** **Ahoy Mateys (LCC, Admiral Brass, Unsinkable, 25; `01P5KQkY`, 2026-09-25 run 3).** **Elven Empire (KHC, Lathril, Blade of the Elves, 26; `01RyGJHK`, 2026-09-25 run 1).** **Revenant Recon (MKC, Mirko, Obsessive Theorist, 25; `01TfrB1i`, 2026-09-25 run 1).** **The Hosts of Mordor (LTC, Sauron, Lord of the Rings, 25; `015cKV6u`, 2026-09-25 run 7).** Claim in this line, pushed on its own, before starting a list.
