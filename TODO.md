...
13. 💡 **THE NEXT CARD WORK IS ALREADY CENSUSED: 23 of the 178 dropped-"may" rows are in the CUBE pool**, the 2-player simulator's own deck space, where a dropped choice is a live defect in the trained path. Catalog edits, ready to take: Restoration Angel, Liliana the Last Hope's −2, Grapple with the Past, Grisly Salvage, Malevolent Rumble, Beastmaster Ascension, Chrome Mox / Isochron Scepter (as-enters imprint), Jace the Mind Sculptor. ⚠ Deep-Cavern Bat and Elite Spellbinder may be `RESOLVER_OPTIONAL` exemptions instead — read their arms before wrapping.
