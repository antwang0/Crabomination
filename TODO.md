...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Nature's Vengeance (C18, Gyrus, Waker of Corpses, 18; `011A87o2`, 2026-09-24 14:21 UTC — yielded Death Toll to `01546QdT`, who claimed first).** **Blame Game (MKC, Nelly Borca, Impulsive Accuser, 18; `018BnccM`, 2026-09-24).** **Planeswalker Party (CMM, Commodore Guff, 17; `01StaUuo`, 2026-09-24 run 5).** **Reign of Dragons (FDC, 13; `01P5KQkY`, 2026-09-24 run 2).** **Family Matters (BLC, Zinnia, Valley's Voice, 19; `01XnuL2a`, 2026-09-24 run 4).** **20 Ways to Win (SLD, Go-Shintai of Life's Origin, 17; `01546QdT`, 2026-09-24 19:30).** **Draconic Domination (C17, The Ur-Dragon, 18; `015cKV6u`, 2026-09-24 run 5).** Claim in this line, pushed on its own, before starting a list.
