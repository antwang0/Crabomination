...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Bedecked Brokers (NCC, Perrie, the Pulverizer, 21; `016DJoKA`, 2026-09-25 run 1).** **Explorers of the Deep (LCC, Hakbal of the Surging Soul, 21; `01TfrB1i`, 2026-09-25 run 1).** **Dance of the Elements (ECC, Ashling, the Limitless, 22; `018BnccM`, 2026-09-25 run 5).** **Elven Council (LTC, Galadriel, Elven-Queen, 23; `01P5KQkY`, 2026-09-25 run 3).** Claim in this line, pushed on its own, before starting a list.
