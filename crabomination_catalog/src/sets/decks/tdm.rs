...
use crate::mana::{Color, b, cost, g, generic, mono_hybrid, r, u, w, x};
    ...
    CardDefinition {
        ...
        equipped_bonus: Some(EquipBonus {
            ...
            triggered_abilities: vec![TriggeredAbility {
                ...
                effect: Effect::If {
                    cond: Predicate::AttackedWithCountAtLeast {
                        who: PlayerRef::You,
                        at_least: 3,
                    },
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::MayPay {
                description: "Pay {1}{W}: return Furious Forebear from your graveyard to hand"
                    .into(),
...
pub fn traveling_botanist() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::LookTopLandToHandElseBin {
                who: PlayerRef::You,
            },
        }],
        ..Default::default()
...
pub fn abzan_monument() -> CardDefinition {
    let greatest_toughness = || Value::ToughnessOf(Box::new(Selector::GreatestToughnessYouControl));
    CardDefinition {
        name: "Abzan Monument",
        cost: cost(&[generic(2)]),
        card_types: vec![CardType::Artifact],
...
pub fn eshki_dragonclaw() -> CardDefinition {
    ...
    CardDefinition {
        ...
        keywords: vec![
            Keyword::Vigilance,
            Keyword::Trample,
            Keyword::Ward(WardCost::generic(1)),
        ],
        triggered_abilities: vec![TriggeredAbility {
            event: EventSpec::new(
...
pub fn death_begets_life() -> CardDefinition {
    ...
    CardDefinition {
        ...
        effect: Effect::Seq(vec![
            ...
            Effect::Destroy {
                what: Selector::EachPermanent(matching()),
            },
        ]),
        ..Default::default()
    }
