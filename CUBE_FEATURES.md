...
| Fallen Shinobi | 🟡 | 5/4 Zombie Ninja. Combat damage exiles the defender's top two cards and grants the controller a may-play (free cast) on each until EOT (`Effect::ExileTopAndGrantMayPlay ×2`). Only Ninjutsu remains omitted (no Ninjutsu keyword/attacker-swap yet). |
