...
use crate::card::{
    ...
    Keyword, MayPlayDuration, Predicate, SelectionRequirement, Selector, Subtypes, Supertype,
...
pub fn dawnhart_mentor() -> CardDefinition {
    ...
    CardDefinition {
        ...
        activated_abilities: vec![ActivatedAbility {
            ...
            condition: Some(Predicate::CovenActive {
                who: PlayerRef::You,
            }),
...
pub fn dawnhart_wardens() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            .with_filter(Predicate::CovenActive {
                who: PlayerRef::You,
            }),
        ...
        triggered_abilities: vec![
            ...
            TriggeredAbility {
                ...
                effect: Effect::MaySacrifice {
                    description: "Sacrifice a Blood token? (Bloodcrazed Socialite gets +2/+2)"
                        .into(),
...
pub fn falcon_abomination() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::CreateToken {
            who: PlayerRef::You,
            count: Value::Const(1),
            definition: Box::new(decayed_zombie_token()),
        })],
        ..Default::default()
    }
}
...
pub fn dawnhart_geist() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            event: EventSpec::new(EventKind::SpellCast, EventScope::YourControl).with_filter(
                Predicate::CastSpellMatches(SelectionRequirement::HasCardType(
...
pub fn covetous_castaway() -> CardDefinition {
    ...
    let castigator = CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::MayDo {
            description: "Shuffle up to three target cards from your graveyard into your library"
                .into(),
            body: Box::new(Effect::Move {
                what: Selector::Take {
                    inner: Box::new(Selector::CardsInZone {
...
pub fn tovolars_huntmaster() -> CardDefinition {
    ...
    let two_wolves = || Effect::CreateToken {
        who: PlayerRef::You,
        count: Value::Const(2),
        definition: Box::new(wolf()),
    };
            ...
            effect: Effect::Fight {
                attacker: Selector::TargetFiltered {
                    ...
                    filter: SelectionRequirement::ControlledByYou
                        .and(SelectionRequirement::OtherThanSource)
                        .and(
                            SelectionRequirement::HasCreatureType(CreatureType::Wolf).or(
            ...
            Effect::CounterSpell {
                what: Selector::TargetFiltered {
                    ...
                    filter: SelectionRequirement::IsSpellOnStack
                        .and(SelectionRequirement::Creature.or(SelectionRequirement::Enchantment)),
                },
            },
...
pub fn razorkin_hordecaller() -> CardDefinition {
    ...
    CardDefinition {
        ...
        toughness: 4,
        keywords: vec![Keyword::Haste],
        triggered_abilities: vec![crate::effect::shortcut::on_you_attack(
            Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: Box::new(TokenDefinition {
...
pub fn nullpriest_of_oblivion() -> CardDefinition {
    CardDefinition {
        ...
        keywords: vec![
            Keyword::Lifelink,
            Keyword::Menace,
            Keyword::Kicker(cost(&[generic(3), b()])),
        ],
        triggered_abilities: vec![etb(Effect::If {
            cond: Predicate::SpellWasKicked,
...
pub fn dalek_squadron() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Artifact, CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Dalek],
            ..Default::default()
        },
        power: 3,
        toughness: 3,
    ...
    CardDefinition {
        ...
        effect: Effect::Seq(vec![
            Effect::GrantKeyword {
                what: target_filtered(
                    SelectionRequirement::Creature
                        .or(SelectionRequirement::HasCardType(CT::Artifact)),
                ),
                keyword: Keyword::Hexproof,
                duration: Duration::EndOfTurn,
            },
...
pub fn lumbering_worldwagon() -> CardDefinition {
    ...
    CardDefinition {
        ...
        power: 0,
        toughness: 4,
        dynamic_pt: Some(DynamicPt::LandsControlledPower {
            base_p: 0,
            base_t: 4,
        }),
...
pub fn workshop_warchief() -> CardDefinition {
    ...
    CardDefinition {
        ...
        toughness: 3,
        keywords: vec![Keyword::Trample],
        alternative_cost: Some(crate::effect::shortcut::blitz(cost(&[
            generic(4),
            g(),
            g(),
        ]))),
...
pub fn squee_dubious_monarch() -> CardDefinition {
    ...
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Goblin, CreatureType::Noble],
            ..Default::default()
        },
        power: 2,
        toughness: 2,
...
pub fn headless_rider() -> CardDefinition {
    let make = || Effect::CreateToken {
        who: PlayerRef::You,
        count: Value::Const(1),
        definition: Box::new(black_zombie_token()),
    };
    CardDefinition {
        name: "Headless Rider",
        cost: cost(&[generic(2), b()]),
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: Box::new(tapped_zombie),
            },
        }],
        ..Default::default()
    }
...
pub fn porcelain_legionnaire() -> CardDefinition {
    use crate::mana::{Color, phyrexian};
    CardDefinition {
