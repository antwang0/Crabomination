    ...
    CardDefinition {
        ...
        triggered_abilities: vec![on_dies(Effect::Seq(vec![
            Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::ONE,
                definition: std::sync::Arc::new(phyrexian_wurm(1, 2, Keyword::Deathtouch)),
            },
            Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::ONE,
                definition: std::sync::Arc::new(phyrexian_wurm(2, 1, Keyword::Lifelink)),
            },
        ]))],
        ..Default::default()
    }
            ...
            (
                ...
                Effect::Seq(vec![
                    Effect::CreateToken {
                        who: PlayerRef::You,
                        count: Value::ONE,
                        definition: std::sync::Arc::new(cat_warrior()),
                    },
