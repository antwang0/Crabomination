...
2. **Gates at this run's tip (2026-09-25, session `016DJoKA` run 1, after Wakanda Forever):** suite **22,654 / 0 / 7**; workspace clippy **0**; `release-fast` typecheck clean; `--bench` **195,806 / 0 stalls — byte-identical** after every primitive; 4 / 6 / 8-seat pods (1,000 each, `--card-census`) all decided for seats 138, 146, 152, 157, 160 and 167, nothing unplayed, plus an 8-seat pod of this run's lists (seed 167) 1,000/1,000; strict debug pods 400/400 per seat.
