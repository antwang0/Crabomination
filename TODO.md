...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Buckle Up (NEC, Kotori, Pilot Prodigy, 23; `01TfrB1i`, 2026-09-25 run 1).** **Mystic Intellect (C19, Sevinne, the Chronoclasm, 23; `01RyGJHK`, 2026-09-25 run 1).** **Merciless Rage (C19, Anje Falkenrath, 24; `016DJoKA`, 2026-09-25 run 1).** **Veloci-Ramp-Tor (LCC, Pantlaza, Sun-Favored, 25; `018BnccM`, 2026-09-25 run 5).** Claim in this line, pushed on its own, before starting a list.
