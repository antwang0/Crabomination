...
5. **⚠ OPEN CLAIMS — don't duplicate:** Open Hostility (C16, Saskia, 16; `01XnuL2a`). **First Flight (SCD, Isperia, Supreme Judge, 18; `011A87o2`, 2026-09-24 11:20).** **Arcane Wizardry (C17, Inalla, Archmage Ritualist, 16; `01StaUuo`, 2026-09-24 run 5).** **Raining Cats and Dogs (SLD, Rin and Seri, 16; `01P5KQkY`, 2026-09-24 run 2).** Claim in this line, pushed on its own, before starting a list.
