...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Call for Backup (MOC, Bright-Palm, Soul Awakener, 16; `01P5KQkY`, 2026-09-24 run 2).** **Exquisite Invention (C18, Saheeli, the Gifted, 17; `01StaUuo`, 2026-09-24 run 5).** **Witherbloom Witchcraft (C21, Willowdusk, Essence Seer, 17; `015cKV6u`, 2026-09-24 run 2).** **Squirreled Away (BLC, Hazel of the Rootbloom, 17; `01XnuL2a`, 2026-09-24 run 4).** Claim in this line, pushed on its own, before starting a list.
