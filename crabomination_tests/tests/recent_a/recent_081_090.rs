...
mod recent81 {
    ...
    fn vampiric_rites_sacrifices_for_life_and_a_card() {
        ...
        g.perform_action(GameAction::ActivateAbility {
            card_id: rites, ability_index: 0, target: None, additional_targets: vec![], x_value: None, mode: None,
    ...
    fn underworld_coinsmith_activated_drain() {
        ...
        g.players[0].mana_pool.add(crabomination::mana::Color::Black, 1);
        g.perform_action(GameAction::ActivateAbility {
            card_id: cs, ability_index: 0, target: None, additional_targets: vec![], x_value: None, mode: None,
...
mod recent83 {
    ...
    fn vine_trellis_taps_for_green() {
        ...
        g.clear_sickness(vt);
        g.perform_action(GameAction::ActivateAbility {
            card_id: vt, ability_index: 0, target: None, additional_targets: vec![], x_value: None, mode: None,
        }).expect("tap for G");
    ...
    fn overgrown_battlement_scales_with_defenders() {
        ...
        g.clear_sickness(ob);
        g.perform_action(GameAction::ActivateAbility {
            card_id: ob, ability_index: 0, target: None, additional_targets: vec![], x_value: None, mode: None,
...
mod recent85 {
    ...
    fn cr_702_36_granted_fear_restricts_blockers() {
        ...
        let check = |g: &mut GameState, def: crabomination::card::CardDefinition| -> bool {
            ...
            crabomination::game::can_block_attacker_computed(&inst, &cp, &atk_kws, crabomination::mana::ColorSet::empty(), 2)
        };
...
mod recent90 {
    ...
    fn runaway_steam_kin_gains_counters_capped_at_three_then_taps_for_mana() {
        ...
        g.perform_action(GameAction::ActivateAbility {
            card_id: kin, ability_index: 0, target: None, additional_targets: vec![], x_value: None, mode: None,
        }).expect("activation");
    ...
    fn rummaging_goblin_loots() {
        ...
        g.add_card_to_library(0, catalog::forest());
        g.perform_action(GameAction::ActivateAbility {
            card_id: rg, ability_index: 0, target: None, additional_targets: vec![], x_value: None, mode: None,
        }).expect("loot");
        drain_stack(&mut g);
