# Shipped features (don't re-propose)

Moved verbatim out of `FEATURE_ROADMAP.md` when that file passed the ~1k-line
size trigger. This is the "already exists" index the roadmap is checked
against before anything is proposed; git is the authoritative record.
