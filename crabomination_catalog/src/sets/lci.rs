...
pub fn trumpeting_carnosaur() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::Discover {
            n: Value::Const(5),
            filter: None,
        })],
...
pub fn clay_fired_bricks() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::Seq(vec![
            Effect::Search {
                who: PlayerRef::You,
                filter: SelectionRequirement::HasLandType(LandType::Plains).and(
                    SelectionRequirement::HasSupertype(crate::card::Supertype::Basic),
                ),
    ...
    CardDefinition {
        ...
        static_abilities: vec![StaticAbility {
            ...
            effect: StaticEffect::PumpSelfIf {
                condition: Predicate::DescendActive {
                    who: PlayerRef::You,
                    count: 4,
                },
                power: 2,
...
pub fn basking_capybara() -> CardDefinition {
    ...
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Capybara],
            ..Default::default()
        },
        power: 1,
        toughness: 3,
...
pub fn kinjallis_dawnrunner() -> CardDefinition {
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::Explore {
            who: Selector::This,
        })],
        ..Default::default()
    }
...
pub fn hermitic_nautilus() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Artifact, CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Nautilus],
            ..Default::default()
        },
        power: 1,
        toughness: 4,
...
pub fn hidden_courtyard() -> CardDefinition {
    hidden_cave("Hidden Courtyard", Color::White, cost(&[generic(4), w()]))
}
pub fn hidden_cataract() -> CardDefinition {
    hidden_cave("Hidden Cataract", Color::Blue, cost(&[generic(4), u()]))
}
pub fn hidden_necropolis() -> CardDefinition {
    hidden_cave("Hidden Necropolis", Color::Black, cost(&[generic(4), b()]))
}
pub fn hidden_volcano() -> CardDefinition {
    hidden_cave("Hidden Volcano", Color::Red, cost(&[generic(4), r()]))
}
pub fn hidden_nursery() -> CardDefinition {
    hidden_cave("Hidden Nursery", Color::Green, cost(&[generic(4), g()]))
}
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            event: EventSpec::new(EventKind::Attacks, EventScope::SelfSource).with_filter(
                Predicate::Not(Box::new(Predicate::SelectorExists(
                    Selector::EachPermanent(
...
pub fn petrify() -> CardDefinition {
    ...
    CardDefinition {
        ...
        effect: Effect::Attach {
            what: Selector::This,
            to: target_filtered(SelectionRequirement::Creature.or(SelectionRequirement::Artifact)),
        },
        equipped_bonus: Some(EquipBonus {
            keywords: vec![
                Keyword::CantAttack,
...
pub fn nurturing_bristleback() -> CardDefinition {
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![etb(Effect::CreateToken {
            who: PlayerRef::You,
            count: Value::Const(1),
            definition: std::sync::Arc::new(dino),
        })],
        ..Default::default()
    }
}
...
pub fn primordial_gnawer() -> CardDefinition {
    CardDefinition {
        ...
        power: 5,
        toughness: 2,
        triggered_abilities: vec![on_dies(Effect::Discover {
            n: Value::Const(3),
            filter: None,
        })],
        ..Default::default()
...
pub fn glowcap_lantern() -> CardDefinition {
    ...
    CardDefinition {
        ...
        equipped_bonus: Some(EquipBonus {
            triggered_abilities: vec![on_attack(Effect::Explore {
                who: Selector::This,
            })],
            ..Default::default()
        }),
    ...
    CardDefinition {
        ...
        effect: Effect::DealDamage {
            ...
            amount: Value::Max(
                ...
                Box::new(Value::PowerOf(Box::new(
                    Selector::GreatestPowerControlledMatching(
                        SelectionRequirement::HasCreatureType(CreatureType::Dinosaur),
                    ),
                ))),
            ),
    ...
    CardDefinition {
        ...
        activated_abilities: vec![ActivatedAbility {
            ...
            effect: Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: std::sync::Arc::new(demon),
            },
            ..Default::default()
        }],
        ..Default::default()
...
pub fn threefold_thunderhulk() -> CardDefinition {
    ...
    let make_gnomes = move || Effect::CreateToken {
        who: PlayerRef::You,
        count: Value::PowerOf(Box::new(Selector::This)),
        definition: std::sync::Arc::new(gnome.clone()),
    };
    CardDefinition {
...
pub fn envoy_of_okinec_ahau() -> CardDefinition {
    ...
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Cat, CreatureType::Advisor],
            ..Default::default()
        },
        power: 3,
        toughness: 3,
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![
            etb(Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(1),
                definition: std::sync::Arc::new(skeleton_pirate),
            }),
...
pub fn zoetic_glyph() -> CardDefinition {
    ...
    CardDefinition {
        ...
        effect: Effect::Attach {
            what: Selector::This,
            to: target_filtered(SelectionRequirement::Artifact),
        },
        equipped_bonus: Some(EquipBonus {
...
pub fn uchbenbak_the_great_mistake() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Skeleton, CreatureType::Horror],
            ..Default::default()
        },
        power: 6,
        toughness: 4,
        ...
        activated_abilities: vec![ActivatedAbility {
            ...
            from_graveyard: true,
            sorcery_speed: true,
            condition: Some(Predicate::DescendActive {
                who: PlayerRef::You,
                count: 8,
            }),
            effect: Effect::Seq(vec![
    ...
    CardDefinition {
        ...
        static_abilities: vec![StaticAbility {
            ...
            effect: StaticEffect::CanAttackIgnoringDefenderWhile {
                condition: Predicate::ArtifactEnteredThisTurn {
                    who: PlayerRef::You,
                },
            },
        }],
...
pub fn deepfathom_echo() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Merfolk, CreatureType::Spirit],
            ..Default::default()
        },
        power: 4,
        toughness: 4,
...
pub fn sovereign_okinec_ahau() -> CardDefinition {
    CardDefinition {
        ...
        power: 3,
        toughness: 4,
        keywords: vec![Keyword::Ward(crate::card::WardCost::Mana(cost(&[
            generic(2),
        ])))],
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![
            etb(Effect::CreateToken {
                who: PlayerRef::You,
                count: Value::Const(2),
                definition: std::sync::Arc::new(egg),
            }),
            TriggeredAbility {
                event: EventSpec::new(
                    EventKind::StepBegins(TurnStep::BeginCombat),
                ...
                effect: Effect::Seq(vec![
                    Effect::Sacrifice {
                        who: Selector::You,
                        count: Value::Const(1),
                        filter: SelectionRequirement::HasCreatureType(CreatureType::Egg),
                    },
                    Effect::CreateToken {
                        who: PlayerRef::You,
                        count: Value::Const(1),
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::RevealTopNPutMatchingToBattlefield {
                ...
                filter: SelectionRequirement::Creature.and(SelectionRequirement::HasCreatureType(
                    CreatureType::Dinosaur,
                )),
            },
        }],
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::CreateToken {
                ...
                definition: std::sync::Arc::new(fungus),
            },
        }],
        ..Default::default()
    }
