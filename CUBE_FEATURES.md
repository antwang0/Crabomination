...
| Sab-Sunen, Luxa Embodied | 🟡 | {3}{G}{U} 6/6 God, reach/trample/indestructible + precombat-main "put a +1/+1 counter, draw 2 if odd" (via new `Predicate::ValueIsOdd`). The "can't attack/block unless even counters" restriction needs a parity attack-gate keyword and is dropped. Test: `sab_sunen_draws_two_on_odd_counter_main_phase`. |
