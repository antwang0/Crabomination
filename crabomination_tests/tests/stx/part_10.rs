...
fn witherbloom_rotsplash_shrinks_creature_and_gains_one_life() {
    ...
    g.perform_action(GameAction::CastSpell {
        card_id: id,
        target: Some(crabomination::game::types::Target::Permanent(opp)),
        additional_targets: vec![],
        mode: None,
        x_value: None,
    })
...
fn strixhaven_crucible_activation_drains_one() {
    ...
    g.perform_action(GameAction::ActivateAbility {
        card_id: id,
        ability_index: 0,
        target: Some(crabomination::game::types::Target::Player(1)), additional_targets: Vec::new(), x_value: None })
...
fn silverquill_lawscribe_etb_taps_opp_creature() {
    ...
    g.players[0].mana_pool.add_colorless(2);
    g.perform_action(GameAction::CastSpell {
        card_id: id, target: Some(crabomination::game::types::Target::Permanent(prey)),
