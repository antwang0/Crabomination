...
pub const SIGARDA_MAIN: &[CardFactory] = &[
    ...
    selesnya_signet, railway_brawler,
    restless_prairie, talisman_of_unity, seedborn_muse, selfless_spirit, senseis_divining_top,
...
pub const HANNA_MAIN: &[CardFactory] = &[
    ...
    consider, curiosity, talisman_of_progress, daru_warchief, demystify, eiganjo_seat_of_the_empire,
    ...
    azorius_signet, isolate, kozileks_command, lodestone_golem, mana_vault, mind_stone,
...
pub const TATYOVA_MAIN: &[CardFactory] = &[
    ...
    simic_signet, sakura_tribe_elder, shelldock_isle, shifting_woodland, sol_ring,
    somber_hoverguard, spark_double, spellseeker, spike_feeder, talisman_of_curiosity, thragtusk,
