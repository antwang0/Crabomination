...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Forces of the Imperium (40K, Inquisitor Greyfax, 35; `01P5KQkY`, 2026-09-25 run 3).** **Scrappy Survivors (PIP, Dogmeat, Ever Loyal, 38; `01TfrB1i`, 2026-09-25 run 1).** **Avengers Assemble (MSC, Captain America, Team Leader, 38; `011z4qQX`, 2026-09-25).** Claim in this line, pushed on its own, before starting a list.
