...
2. **Gates at this run's tip (2026-09-25, session `01TfrB1i` run 1, after Tyranid Swarm as seat 175, rebased on the lockdown-Aura fix):** suite **22,755 / 0 / 7** (strict answer log); workspace clippy **0**; `--bench` **200,190 decisions / 28.12 turns** (the new invariant, PERF); `release-fast` check green; pods for seats 173 (seeds 17301/17302) and 175 (17501/17502, 4- and 6-seat, `--card-census`: nothing unplayed) 1,000/1,000 decided.
