...
pub fn suppression_ray() -> CardDefinition {
    ...
    CardDefinition {
        ...
        back_face: Some(Box::new(dual_tapland(
            "Orderly Plaza",
            Color::White,
            Color::Blue,
        ))),
...
pub fn genku_future_shaper() -> CardDefinition {
    ...
    let moonfolk = TokenDefinition {
        ...
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Moonfolk],
            ..Default::default()
        },
        keywords: vec![Keyword::Flying],
        ..Default::default()
    ...
    CardDefinition {
        ...
        triggered_abilities: vec![TriggeredAbility {
            ...
            effect: Effect::ChooseMode(vec![mk(std::sync::Arc::new(fox)), mk(std::sync::Arc::new(moonfolk)), mk(std::sync::Arc::new(rat))]),
        }],
        activated_abilities: vec![ActivatedAbility {
