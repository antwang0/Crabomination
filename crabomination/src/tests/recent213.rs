...
fn wildwood_scourge_tracks_counters() {
    ...
    let evs = g.resolve_effect(&crate::effect::Effect::AddCounter {
...
fn sanguine_indulgence_life_discount() {
    let mut g = two_player_game();
    let spell = crate::card::CardInstance::new(g.next_id(), catalog::sanguine_indulgence(), 0);
...
fn sanguine_indulgence_returns_creatures() {
    ...
    g.decider = Box::new(crate::decision::ScriptedDecider::new([
        crate::decision::DecisionAnswer::Target(Target::Permanent(c1)),
        crate::decision::DecisionAnswer::Target(Target::Permanent(c2)),
    ]));
