...
fn test_card_die_roll_d6_big_gain() -> crabomination::card::CardDefinition {
    use crabomination::card::{CardDefinition, CardType};
    use crabomination::effect::{Effect, Selector, Value};
    use crabomination::mana::{cost, generic};
    CardDefinition {
...
fn test_card_die_roll_d6_partial_table() -> crabomination::card::CardDefinition {
    use crabomination::card::{CardDefinition, CardType};
    use crabomination::effect::{Effect, Selector, Value};
    use crabomination::mana::{cost, generic};
    CardDefinition {
...
fn test_card_die_roll_d6_plus(modifier: i32) -> crabomination::card::CardDefinition {
    use crabomination::card::{CardDefinition, CardType};
    use crabomination::effect::{Effect, Selector, Value};
    use crabomination::mana::{cost, generic};
    CardDefinition {
...
fn test_card_die_roll_d6_reroll(reroll_at_most: u8) -> crabomination::card::CardDefinition {
    use crabomination::card::{CardDefinition, CardType};
    use crabomination::effect::{Effect, Selector, Value};
    use crabomination::mana::{cost, generic};
    CardDefinition {
...
fn test_card_die_roll_doubles() -> crabomination::card::CardDefinition {
    use crabomination::card::{CardDefinition, CardType};
    use crabomination::effect::{Effect, Selector, Value};
    use crabomination::mana::{cost, generic};
    CardDefinition {
