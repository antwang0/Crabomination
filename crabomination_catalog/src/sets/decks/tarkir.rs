        ...
        triggered_abilities: vec![etb(Effect::Seq(vec![
            ...
            Effect::SearchUpToN {
                ...
                to: ZoneDest::Battlefield {
                    controller: PlayerRef::ControllerOf(Box::new(target_filtered(
                        opp_land.clone(),
                    ))),
                    tapped: true,
                },
...
pub fn cunning_coyote() -> CardDefinition {
    CardDefinition {
        ...
        card_types: vec![CardType::Creature],
        subtypes: Subtypes {
            creature_types: vec![CreatureType::Coyote],
            ..Default::default()
        },
        power: 2,
        toughness: 2,
...
fn monument_etb(
    a: crate::card::LandType,
    b: crate::card::LandType,
    c: crate::card::LandType,
) -> TriggeredAbility {
    etb(Effect::Search {
        who: PlayerRef::You,
...
pub fn jeskai_monument() -> CardDefinition {
    ...
    CardDefinition {
        ...
        cost: cost(&[generic(2)]),
        card_types: vec![CardType::Artifact],
        triggered_abilities: vec![monument_etb(
            LandType::Island,
            LandType::Mountain,
            LandType::Plains,
        )],
