...
5. **⚠ OPEN CLAIMS — don't duplicate:** **20 Ways to Win (SLD, 16; `01StaUuo`, 2026-09-24 run 6) — ⚠ ALREADY LANDED as seat 92 by `01546QdT` (claimed 19:30, landed before this claim); drop it.** **Spirit Squadron (VOC, Millicent, Restless Revenant, 18; `01P5KQkY`, 2026-09-24 run 3).** **Upgrades Unleashed (NEC, Chishiro, the Shattered Blade, 18; `01SSG31v`, 2026-09-24 run 7).** **Eldrazi Unbound (CMM, Zhulodok, Void Gorger, 18; `01StaUuo`, 2026-09-24 run 6).** **Draconic Dissent (CLB, Firkraag, Cunning Instigator, 18; `01546QdT`, 2026-09-24 22:15).** **Prismari Artistry (SOC, Rootha, Mastering the Moment, 19; `015cKV6u`, 2026-09-24 run 6).** **Painbow (DMC, Jared Carthalion, 18; `01XnuL2a`, 2026-09-24 run 4).** Claim in this line, pushed on its own, before starting a list.
