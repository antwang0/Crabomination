...
2. **Gates at this run's tip (2026-09-24, session `01StaUuo`):** suite **21,048 / 0 / 7**; release-fast check green; workspace clippy **0**; `--bench` **195,806 / 0 stalls — byte-identical**, `determinism ok`; 4-seat pods 1,000/1,000 decided per new seat; 12 seats (seed 10134) 200/200; every card of every seated list played in the census.
