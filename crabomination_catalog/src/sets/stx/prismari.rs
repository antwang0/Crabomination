...
// ── Batch 198 (modern_decks) — Prismari (U/R) extension ──────────────────

/// Prismari Sparkroost (b198) — {1}{R} 2/1 Elemental Haste.
/// Cheap haster.
pub fn prismari_sparkroost_b198() -> CardDefinition {
    CardDefinition {
...
/// Prismari Glassblower (b198) — {2}{U} 2/3 Human Artificer.
/// ETB scry 2.
pub fn prismari_glassblower_b198() -> CardDefinition {
    use crate::effect::shortcut::etb_scry;
    CardDefinition {
...
/// Prismari Treasurewright (b198) — {2}{U}{R} 3/3 Elemental Wizard.
/// Magecraft: create a Treasure token.
pub fn prismari_treasurewright_b198() -> CardDefinition {
    CardDefinition {
...
/// Prismari Burst (b198) — {1}{R} Instant.
/// Deal 3 damage to target creature.
pub fn prismari_burst_b198() -> CardDefinition {
    CardDefinition {
...
/// Prismari Cantrip (b198) — {1}{U} Instant.
/// Draw 2 cards.
pub fn prismari_cantrip_b198() -> CardDefinition {
    CardDefinition {
...
/// Prismari Skyforger (b198) — {3}{U}{R} 4/3 Elemental Flying.
/// Mid-range flyer.
pub fn prismari_skyforger_b198() -> CardDefinition {
    CardDefinition {
...
/// Prismari Loot (b198) — {U}{R} Sorcery.
/// Draw 2 cards, then discard 1 card.
pub fn prismari_loot_b198() -> CardDefinition {
    CardDefinition {
...
/// Prismari Magmaforge (b198) — {3}{R} 3/3 Elemental.
/// ETB ping 2 to any target.
pub fn prismari_magmaforge_b198() -> CardDefinition {
    use crate::effect::shortcut::etb_ping_any;
    CardDefinition {
...
// ── Batch 199 (modern_decks) — Prismari rounding-out ─────────────────────

/// Prismari Apprentice II (b199) — {U}{R} 2/2 Elemental Wizard.
/// Magecraft loot (draw 1, discard 1).
pub fn prismari_apprentice_ii_b199() -> CardDefinition {
    CardDefinition {
...
/// Prismari Smolderwight (b199) — {3}{R} 4/3 Elemental.
/// Vanilla 4-mana beater.
pub fn prismari_smolderwight_b199() -> CardDefinition {
    CardDefinition {
...
/// Prismari Surge (b199) — {1}{R} Instant.
/// Target creature gets +2/+0 EOT and gains Trample EOT.
pub fn prismari_surge_b199() -> CardDefinition {
    use crate::effect::shortcut::pump_and_grant_keyword;
    let _ = pump_and_grant_keyword; // sanity
    CardDefinition {
...
/// Prismari Mathlord (b199) — {3}{U} 2/4 Merfolk Wizard Flying.
/// Mid-defender flyer.
pub fn prismari_mathlord_b199() -> CardDefinition {
    CardDefinition {
...
/// Prismari Wavemaster (b199) — {U} 1/1 Merfolk Wizard.
/// ETB Scry 1 (cheap cantrip).
pub fn prismari_wavemaster_b199() -> CardDefinition {
    use crate::effect::shortcut::etb_scry;
    CardDefinition {
...
// ── Batch 203 (modern_decks) — Prismari compact round ────────────────────

/// Prismari Apprentice II (b203) — {U}{R} 2/2 Elemental.
/// Magecraft loot.
pub fn prismari_apprentice_ii_b203() -> CardDefinition {
    CardDefinition {
...
/// Prismari Cantrip (b203) — {U} Instant. Draw a card, then discard a card.
pub fn prismari_cantrip_b203() -> CardDefinition {
    CardDefinition {
...
/// Prismari Counter (b203) — {1}{U} Instant. Counter target spell.
pub fn prismari_counter_b203() -> CardDefinition {
...
/// Prismari Flame (b203) — {2}{R} Sorcery. Deal 4 to any target.
pub fn prismari_flame_b203() -> CardDefinition {
    use crate::effect::shortcut::target_any;
    CardDefinition {
...
/// Prismari Squallcaller II (b203) — {1}{U} 1/3 Elemental. ETB scry 1.
pub fn prismari_squallcaller_ii_b203() -> CardDefinition {
    use crate::effect::shortcut::etb_scry;
    CardDefinition {
...
/// Prismari Mage (b203) — {2}{U}{R} 3/2 Human Wizard. Magecraft +1/+0 self.
pub fn prismari_mage_b203() -> CardDefinition {
    CardDefinition {
...
// ── Batch 204 (modern_decks) — Prismari round 4 ──────────────────────────

/// Prismari Pyromage (b204) — {2}{R} 2/2 Human Wizard.
/// Magecraft ping each opp 1.
pub fn prismari_pyromage_b204() -> CardDefinition {
    CardDefinition {
...
/// Prismari Stormrider (b204) — {3}{U}{R} 4/4 Elemental. Flying. Haste.
/// Top-end finisher.
pub fn prismari_stormrider_b204() -> CardDefinition {
    CardDefinition {
...
/// Prismari Sparkboost (b204) — {R} Instant. Target creature gets +2/+0 EOT.
pub fn prismari_sparkboost_b204() -> CardDefinition {
    CardDefinition {
...
// ─────────────────────────────────────────────────────────────────────────
// Batch 205 (modern_decks) — Prismari (U/R) spell-matters round.
// ─────────────────────────────────────────────────────────────────────────

/// Prismari Flarecaster (b205) — {1}{R} 2/1 Goblin Wizard.
/// Magecraft — whenever you cast or copy an instant or sorcery, this
/// creature deals 1 damage to each opponent.
pub fn prismari_flarecaster_b205() -> CardDefinition {
    CardDefinition {
...
/// Prismari Tidescribe (b205) — {2}{U} 1/4 Human Wizard.
/// ETB — scry 2.
pub fn prismari_tidescribe_b205() -> CardDefinition {
    use crate::effect::shortcut::etb;
    CardDefinition {
...
/// Prismari Emberbolt (b205) — {R} Instant.
/// Deal 2 damage to any target.
pub fn prismari_emberbolt_b205() -> CardDefinition {
    CardDefinition {
...
/// Prismari Stormloot (b205) — {1}{U}{R} 2/2 Elemental Wizard.
/// Magecraft — whenever you cast or copy an instant or sorcery, draw a
/// card, then discard a card (loot).
pub fn prismari_stormloot_b205() -> CardDefinition {
    CardDefinition {
...
/// Prismari Pyrosmith (b205) — {1}{R} 2/2 Goblin Artificer.
/// Magecraft — whenever you cast or copy an instant or sorcery, create a
/// Treasure token.
pub fn prismari_pyrosmith_b205() -> CardDefinition {
    CardDefinition {
...
/// Prismari Galemage (b205) — {2}{U} 2/3 Human Wizard.
/// Magecraft — whenever you cast or copy an instant or sorcery, scry 1.
pub fn prismari_galemage_b205() -> CardDefinition {
    CardDefinition {
...
// ─────────────────────────────────────────────────────────────────────────
// Batch 206 (modern_decks) — Prismari (U/R) staples.
// ─────────────────────────────────────────────────────────────────────────

/// Prismari Inferno (b206) — {3}{R} Sorcery.
/// Deal 4 damage to any target.
pub fn prismari_inferno_b206() -> CardDefinition {
    CardDefinition {
...
/// Prismari Windscholar (b206) — {2}{U} 2/3 Human Wizard.
/// ETB — scry 1, then draw a card.
pub fn prismari_windscholar_b206() -> CardDefinition {
    use crate::effect::shortcut::etb;
    CardDefinition {
...
/// Prismari Pyrologist (b207) — {1}{R} 2/2 Human Wizard.
/// Magecraft — this creature deals 1 damage to each opponent.
pub fn prismari_pyrologist_b207() -> CardDefinition {
    CardDefinition {
...
/// Prismari Goldcaster (b207) — {2}{U} 2/3 Vedalken Wizard.
/// Magecraft — create a Treasure token.
pub fn prismari_goldcaster_b207() -> CardDefinition {
    CardDefinition {
...
/// Prismari Firebolt II (b207) — {2}{R} Instant.
/// Deal 4 damage to target creature, then scry 1.
pub fn prismari_firebolt_ii_b207() -> CardDefinition {
    CardDefinition {
...
/// Prismari Goldsmith (b207) — {1}{U}{R} 2/2 Dwarf Artificer.
/// When this creature enters, create two Treasure tokens.
pub fn prismari_goldsmith_b207() -> CardDefinition {
    CardDefinition {
...
/// Prismari Stormloot (b207) — {3}{U} Sorcery.
/// Draw two cards, then discard a card.
pub fn prismari_stormloot_ii_b207() -> CardDefinition {
    CardDefinition {
...
/// Prismari Galeblaster (b207) — {3}{U}{R} 4/4 Elemental, Haste.
/// Magecraft — this creature gets +1/+0 until end of turn.
pub fn prismari_galeblaster_b207() -> CardDefinition {
    CardDefinition {
