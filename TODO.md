...
5. **⚠ OPEN CLAIMS — don't duplicate:** **Blight Curse (ECC, Auntie Ool, Cursewretch, 30; `01TfrB1i`, 2026-09-25 run 1).** **Counter Blitz (FIC, Tidus, Yuna's Guardian, 28; `011z4qQX`, 2026-09-25).** Claim in this line, pushed on its own, before starting a list.
