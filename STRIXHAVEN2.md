...
- ✅ done: **110** (push XXVIII: 9 SOS cards promoted 🟡 → ✅: Dina's
  Guidance, Pursue the Past, Heated Argument, Stadium Tidalmage,
  Witherbloom Charm, plus 4 MDFCs verified end-to-end: Emeritus of
  Truce // Swords to Plowshares, Cheerful Osteomancer // Raise Dead,
  Harmonized Trio // Brainstorm, Emeritus of Conflict // Lightning Bolt.)
- 🟡 partial: **144** (push XXVIII: -9 from promotions, +2 from ⏳ → 🟡
  of Archaic's Agony and Quandrix the Proof)
