...
2. **Gates at this run's tip (2026-09-25, session `01StaUuo` run 6):** suite **21,747 / 0 / 7**; release-fast check green; workspace clippy **0**; `--bench` **195,806 / 0 stalls — byte-identical**, `determinism ok`; 4-seat pods 1,000 per new seat all decided bar genuine draws; 12 seats 200/200 bar genuine draws; every card of every seated list played in the census.
