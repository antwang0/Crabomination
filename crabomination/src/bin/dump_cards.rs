...
fn keyword_name(kw: &Keyword) -> Option<String> {
    ...
    let s = match kw {
        ...
        Keyword::CantPhaseOut => "Can't phase out",
        ...
        Keyword::Frenzy(_) => "Frenzy",
        Keyword::Ward(_) => "Ward",
        Keyword::Flashback(_) => "Flashback",
        Keyword::FlashbackTap { .. } => "Flashback",
        Keyword::JumpStart => "Jump-start",
        Keyword::GraveyardCast => return None,
        ...
        Keyword::ReplicateEnergy(_) | Keyword::ReplicateTap(_) => "Replicate",
        ...
        | Keyword::CantAttackOrBlockUnlessCardsInExile(_)
