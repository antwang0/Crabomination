...
2. **Gates at this run's tip (2026-09-25, session `018BnccM` run 5, after Hail, Caesar):** suite **22,687 / 0 / 7** (strict answer log); workspace clippy **0**; `--bench` **195,806 / 0 stalls — byte-identical**, `determinism ok`; 4-seat (seed 10520, `--card-census`: nothing unplayed in seats 161/166/169/170) and 6-seat (10521) pods 1,000/1,000 decided; strict debug pods 120/120 after the resume-channel fixes; cube/sos/sealed 7,498 decided + 2 draws (cube seed 10522 — seed-specific, the three earlier seeds re-run clean).
